...
const u8 BattleText_Exclamation2[] = _("{K_EULREUL} 썼다!"); // を つかった!
const u8 BattleText_Exclamation3[] = _("{K_EULREUL} 썼다!"); // した!
const u8 BattleText_Exclamation4[] = _("{K_EULREUL} 썼다!"); // を した!
...
const u8 BattleText_Lanette[] = _("유미의");
