...
const u8 Category_EnglishVersionCoordinators[] = _("{PALETTE 9}NOK Localization Staff");
...
const u8 Text_HiroyukiNakamura[] = _("Hyojun Jo");
...
const u8 Text_Ridgeway[] = _("Sanghyuk Lee");
...
const u8 Text_RNZFotB[] = _("National Federation of the Blind");
