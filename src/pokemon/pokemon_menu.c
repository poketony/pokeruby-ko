...
static const struct PartyPopupMenu sUnknown_0839F578 = {3, 8, sUnknown_39F572};
...
{
    sub_8089BDC(arg0, arg1, arg2, noOfOptions, menuActions, order, 5);
}
...
static void sub_8089C7C(u8 arg0)
{
    ...
    sub_8089BDC(18, r4, 11, sPokeMenuOptionsNo, sPokemonMenuActions, sPokeMenuOptionsOrder, 5);
    r4 |= 1;
    InitMenu(0, 19, r4, sPokeMenuOptionsNo, arg0, 9);
}
...
void DoPokemonMenu_Switch(u8 taskID)
{
    ...
    MenuZeroFillWindowRect(18, 0, 29, 19);
}
