...
static bool32 InitStartMenuMultistep(s16 *step, s16 *index)
{
    ...
    case 1:
        ...
        break;
    case 2:
        MenuDrawTextWindow(21, 0, 29, sNumStartMenuActions * 2 + 3);
        *index = 0;
        (*step)++;
        break;
    case 3:
    ...
    case 0:
        ...
        break;
    case 5:
        sStartMenuCursorPos = InitMenu(0, 22, 2, sNumStartMenuActions, sStartMenuCursorPos, 6);
        return TRUE;
    }
    return FALSE;
}
...
static void HideSaveDialog(void)
{
    MenuZeroFillWindowRect(20, 8, 27, 13);
}
