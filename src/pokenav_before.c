...
void sub_80EF9F8(void)
{
	...
	case 1:
	case 4:
		sub_8072A18(gUnknown_083DFEC4->regionMap.mapSectionName, 0x88, var1 * 8, 0x78, 1);
		var1 += 2;
		...
		else
		{
			...
			{
				sub_8072A18(mapSectionName, 0x88, var1 * 8, 0x78, 1);
				var1 += 2;
				i++;
			}
	...
	case 2:
		...
		if (*pointer != NULL)
		{
			MenuFillWindowRectWithBlankTile(17, var1, 28, 15);
			MenuFillWindowRectWithBlankTile(26, var1, 28, 15);

			sub_8095C8C((void *)VRAM + 0xF800, 18, 6, *pointer, 0, 0, 10, 10, 10);
...
{
	sub_8095C8C((void *)VRAM + 0xF800, 17, 16, gUnknown_08E9AC2C, 0, 0, 12, 1, 15);
	gUnknown_083DFEC4->unk769E = 0;
}
...
void sub_80EFDE4(u8 param0)
{
	...
	{
		sub_8095C8C((void *)VRAM + 0xF800, 17, 16, gUnknown_08E9ABB4, gUnknown_083DFEC4->unk769C, 0, var1, 1, 60);

		if (var1 < 12)
		{
			u16 var2 = var1 + 17;

			sub_8095C8C((void *)VRAM + 0xF800, var2, 16, gUnknown_08E9ABB4, 0, 0, (u16)(12 - var1), 1, 60);
		}
	}
}
...
bool8 sub_80EFF68(void)
{
	...
	case 9:
		...
		{
			sub_8095C8C((void *)VRAM + 0xF800, 0, 5, gUnknown_083E01AC, 0, 0, 9, 4, 9);
		}
		break;
	case 10:
