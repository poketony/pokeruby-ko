...
const u8 gDexText_Searching[] = _("검색을 하고 있습니다...");
...
const u8 gOtherText_TakenAndReplaced[] = _("{STR_VAR_2}\f 가져오고\n{STR_VAR_1}\f 지니게 했습니다!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_AlreadyKnows[] = _("{STR_VAR_1}\s 이미\n{STR_VAR_2}\f 기억하고 있습니다{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_RegainedHealth[] = _("{STR_VAR_1}\s\n기력을 회복했다!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_ElevatedTo[] = _("{STR_VAR_1}\s\n레벨{STR_VAR_2}\d로 올랐다!");
const u8 gOtherText_WasRaised[] = _("{STR_VAR_1}\s {STR_VAR_2}의\n기초포인트가 올라갔다!{PAUSE_UNTIL_PRESS}");
...
const u8 gSecretBaseText_WillBeDiscarded[] = _("{STR_VAR_1}\r 없어져 버립니다만\n괜찮겠습니까?");
...
const u8 PCText_WasDeposited[] = _("\f 맡겼습니다");
...
const u8 gOtherText_StopGivingMail[] = _("메일 맡기기를 그만두겠습니까?"); //メ-ルを もたせるのを やめますか?
