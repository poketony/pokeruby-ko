...
sub_809E044: @ 809E044
	push {r4,r5,lr}
	ldr r4, _0809E0F4 @ =gSummaryScreenPalette+0x1C
	adds r0, r4, 0
	movs r1, 0x81
	movs r2, 0x2
	bl LoadPalette
	...
	bx r0
	.align 2, 0
_0809E0F4: .4byte gSummaryScreenPalette+0x1C
_0809E0F8: .4byte gFontDefaultPalette
	thumb_func_end sub_809E044
	thumb_func_start sub_809E044

	thumb_func_start OptionMenuLoadPalette
OptionMenuLoadPalette: @ 809E044
	push {r4,r5,lr}
	ldr r4, _SummayScreenPalette
	adds r5, r4, 0x2
	subs r5, 0x12
	adds r0, r4, 0
	subs r0, 0x1A
	...
	bx r0
	.align 2, 0
_SummayScreenPalette: .4byte gSummaryScreenPalette+0x1C
_FontDefaultPalette:  .4byte gFontDefaultPalette
	thumb_func_end OptionMenuLoadPalette
...
sub_80A0B88: @ 80A0B88
	...
	cmp r5, 0
	bne _080A0BA8
	ldr r0, _080A0BA4 @ =gOtherText_None
	movs r1, 0x15
	movs r2, 0x4
	bl MenuPrint
	b _080A0BD8
...
_080A0BA8:
	ldr r0, _080A0BEC @ =gOtherText_Ribbons00
	movs r1, 0x15
	movs r2, 0x4
	bl MenuPrint
	ldr r0, _080A0BE8 @ =gStringVar1
	adds r1, r5, 0
	movs r2, 0x1
	movs r3, 0x2
