# 1 "src/script_pokemon_util_80F99CC.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/script_pokemon_util_80F99CC.c"
...
# 2 "src/script_pokemon_util_80F99CC.c" 2
...
# 3 "src/script_pokemon_util_80F99CC.c" 2
...
# 4 "src/script_pokemon_util_80F99CC.c" 2
...
# 5 "src/script_pokemon_util_80F99CC.c" 2
# 1 "include/data2.h" 1
...
# 6 "src/script_pokemon_util_80F99CC.c" 2
...
# 7 "src/script_pokemon_util_80F99CC.c" 2
...
# 8 "src/script_pokemon_util_80F99CC.c" 2
...
# 9 "src/script_pokemon_util_80F99CC.c" 2

# 1 "include/pokemon.h" 1
# 11 "src/script_pokemon_util_80F99CC.c" 2
...
# 12 "src/script_pokemon_util_80F99CC.c" 2
...
# 13 "src/script_pokemon_util_80F99CC.c" 2
...
# 14 "src/script_pokemon_util_80F99CC.c" 2
...
# 15 "src/script_pokemon_util_80F99CC.c" 2
# 1 "include/songs.h" 1
...
# 16 "src/script_pokemon_util_80F99CC.c" 2
# 1 "include/sound.h" 1
...
# 17 "src/script_pokemon_util_80F99CC.c" 2
...
# 18 "src/script_pokemon_util_80F99CC.c" 2
# 1 "include/task.h" 1
# 19 "src/script_pokemon_util_80F99CC.c" 2
# 1 "include/text.h" 1
# 20 "src/script_pokemon_util_80F99CC.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 21 "src/script_pokemon_util_80F99CC.c" 2
...
void sub_80F9EEC(void)
{
    ...
    (*(struct UnknownStruct2018000 *)(gSharedMem + 0x18000)).unk8 = 3;
    gFieldCallback = sub_8080990;
}

void ScrSpecial_CountPokemonMoves(void)
{
    u8 i;
    ...
    for (i = 0; i < 4; i++)
        if (GetMonData(&gPlayerParty[gSpecialVar_0x8004], 13 + i))
            gScriptResult++;
}
...
void ScrSpecial_GetPokemonNicknameAndMoveName(void)
{
    ...
    u16 data = GetMonData(pkmn, 13 + gSpecialVar_0x8005);
...
# 424 "src/script_pokemon_util_80F99CC.c"
}
