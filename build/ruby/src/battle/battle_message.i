...
const u8 BattleText_StoppedWorking[] = _("우리 편 {STRING 0}{K_IGA}\n멈췄다!");
const u8 BattleText_StoppedWorking2[] = _("상대 {STRING 0}{K_IGA}\n멈췄다!");
...
const u8 BattleText_RegainedHealth[] = _("{DEFENDING_MON}{K_EUNNEUN}체력을 회복했다!");
...
const u8 BattleText_SafeguardActive[] = _("{DEFENDING_MON}{K_EULREUL}\n신비의 베일이 지켜주고 있다!");
...
const u8 BattleText_Wrapped[] = _("{DEFENDING_MON}{K_EUNNEUN}\n{ATTACKING_MON}에게 휘감겼다!");
const u8 BattleText_Clamped[] = _("{ATTACKING_MON}{K_EUNNEUN}\n{DEFENDING_MON}의 껍질에 꼈다!");
...
const u8 BattleText_KeptGoingCrash[] = _("{ATTACKING_MON}{K_EUNNEUN}\n의욕이 넘쳐서 땅에 부딪혔다!");
...
const u8 BattleText_WoreOff[] = _("{STRING 36} {STRING 0}{K_IGA}\n그쳤다!");
...
const u8 BattleText_PickedUpYen[] = _("{STRING 32}{K_EUNNEUN} {STRING 0}원을 주웠다!\p");
...
const u8 BattleText_MustRecharge[] = _("{ATTACKING_MON}{K_EUNNEUN}\n공격의 반동으로 움직일 수 없다!");
...
const u8 BattleText_StoleSomething[] = _("{ATTACKING_MON}{K_EUNNEUN}\n{DEFENDING_MON}의 {STRING 19}{K_EULREUL} 빼앗았다!");
...
const u8 BattleText_IdentifiedPoke[] = _("{ATTACKING_MON}{K_EUNNEUN}\n{DEFENDING_MON}{K_EULREUL} 간파했다!");
...
const u8 BattleText_CopyStatChanges[] = _("{ATTACKING_MON}{K_EUNNEUN}\n{DEFENDING_MON}의\n능력 변화를 복사했다!");
const u8 BattleText_GotFreeFrom[] = _("{ATTACKING_MON}{K_EUNNEUN}\n{DEFENDING_MON}의 {STRING 0}{K_EU}로부터 풀려났다!");
...
const u8 BattleText_ChoseDestiny[] = _("{ATTACKING_MON}{K_EUNNEUN}\n{STRING 17}{K_EULREUL} 미래에 맡겼다!");
...
const u8 BattleText_CopiedObject[] = _("{ATTACKING_MON}{K_EUNNEUN}\n{DEFENDING_MON}의\l{STRING 22}{K_EULREUL} 복사했다!");
...
const u8 BattleText_KnockedOffItem[] = _("{ATTACKING_MON}{K_EUNNEUN}\n{DEFENDING_MON}의\l {STRING 19}{K_EULREUL} 탁 쳐서 떨구었다!");
...
const u8 BattleText_HustleUse[] = _("{STRING 16}{K_EUNNEUN}\n{STRING 19}{K_EULREUL} 써서 의욕이 넘치기 시작했다!");
...
const u8 BattleText_RestoredHPByItem[] = _("{ATTACKING_MON}{K_EUNNEUN} {STRING 21}{K_EU}로 인해 조금 회복했다");
...
const u8 BattleText_FledWild[] = _("{PLAY_SE SE_NIGERU}야생 {STRING 0}{K_EUNNEUN}\n도망쳤다!");
const u8 BattleText_PlayerDefeatedTrainer[] = _("{STRING 29}{K_WAGWA}의\n승부에서 이겼다!");
const u8 BattleText_PlayerDefeatedTrainers[] = _("{STRING 30}&{STRING 29}{K_WAGWA}의\n승부에서 이겼다!");
const u8 BattleText_PlayerLostTrainer[] = _("{STRING 29}{K_WAGWA}의\n승부에서 졌다!");
const u8 BattleText_PlayerLostTrainers[] = _("{STRING 30}&{STRING 29}{K_WAGWA}의\n승부에서 졌다!");
const u8 BattleText_PlayerTiedTrainer[] = _("{STRING 29}{K_WAGWA}의\n승부에서 비겼다!");
const u8 BattleText_PlayerTiedTrainers[] = _("{STRING 30}&{STRING 29}{K_WAGWA}의\n승부에서 비겼다!");
const u8 BattleText_FledSingle[] = _("{PLAY_SE SE_NIGERU}{STRING 29}{K_EUNNEUN} 도망쳤다!");
const u8 BattleText_FledDouble[] = _("{PLAY_SE SE_NIGERU}{STRING 29}{K_WAGWA} {STRING 30}{K_EUNNEUN} 도망쳤다!");
...
const u8 BattleText_Exclamation2[] = _("!A");
const u8 BattleText_Exclamation3[] = _("!B");
const u8 BattleText_Exclamation4[] = _("!C");
const u8 BattleText_Exclamation5[] = _("!D");
const u8 BattleText_Exclamation[] = _("!E");
