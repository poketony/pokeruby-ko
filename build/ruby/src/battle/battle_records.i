...
# 2 "src/battle/battle_records.c" 2
...
# 3 "src/battle/battle_records.c" 2
# 1 "include/game_stat.h" 1
# 4 "src/battle/battle_records.c" 2
# 1 "include/link.h" 1
# 32 "include/link.h"
enum
{
...
void SerialCB(void);
# 5 "src/battle/battle_records.c" 2
# 1 "include/menu.h" 1
...
# 6 "src/battle/battle_records.c" 2
...
# 7 "src/battle/battle_records.c" 2
...
# 8 "src/battle/battle_records.c" 2
...
# 9 "src/battle/battle_records.c" 2
...
struct TrainerCard {
             ...
             bool8 var_4;
             u8 var_5;
             u16 firstHallOfFameA;
             u16 firstHallOfFameB;
             u16 firstHallOfFameC;
             u16 pokedexSeen;
             u16 trainerId;
             u16 playTimeHours;
             u16 playTimeMinutes;
...
# 10 "src/battle/battle_records.c" 2
...
{
    ConvertIntToDecimalStringN_DigitWidth6(gStringVar1, GetGameStat(23), STR_CONV_MODE_RIGHT_ALIGN, 4);
    ConvertIntToDecimalStringN_DigitWidth6(gStringVar2, GetGameStat(24), STR_CONV_MODE_RIGHT_ALIGN, 4);
    ConvertIntToDecimalStringN_DigitWidth6(gStringVar3, GetGameStat(25), STR_CONV_MODE_RIGHT_ALIGN, 4);
