# 1 "src/battle/post_battle_event_funcs.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/battle/post_battle_event_funcs.c"
...
# 2 "src/battle/post_battle_event_funcs.c" 2
...
# 3 "src/battle/post_battle_event_funcs.c" 2
...
# 4 "src/battle/post_battle_event_funcs.c" 2
...
# 5 "src/battle/post_battle_event_funcs.c" 2
# 1 "include/main.h" 1
...
# 6 "src/battle/post_battle_event_funcs.c" 2
# 1 "include/pokemon.h" 1
# 7 "src/battle/post_battle_event_funcs.c" 2
...
# 8 "src/battle/post_battle_event_funcs.c" 2
...
# 9 "src/battle/post_battle_event_funcs.c" 2
...
int GameClear(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (GetMonData(&gPlayerParty[i], 5)
         ...
         && !GetMonData(&gPlayerParty[i], 67))
        {
            *ptr = 1;
            SetMonData(&gPlayerParty[i], 67, ptr);
            ribbonGet = 1;
        }
    }
