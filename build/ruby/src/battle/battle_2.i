...
# 15 "src/battle/battle_2.c" 2
# 1 "include/pokemon.h" 1
# 16 "src/battle/battle_2.c" 2
# 1 "include/rng.h" 1
...
# 23 "src/battle/battle_2.c" 2
# 1 "include/sprite.h" 1
# 24 "src/battle/battle_2.c" 2
# 1 "include/task.h" 1
# 25 "src/battle/battle_2.c" 2
# 1 "include/text.h" 1
# 26 "src/battle/battle_2.c" 2
# 1 "include/trig.h" 1
...
# 30 "src/battle/battle_2.c" 2
# 1 "include/hold_effects.h" 1
# 31 "src/battle/battle_2.c" 2
...
# 32 "src/battle/battle_2.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 33 "src/battle/battle_2.c" 2
...
void sub_800E9EC(void)
{
    ...
    ((struct BattleStruct *) (gSharedMem + 0x0))->unk2 = r6;
    ((struct BattleStruct *) (gSharedMem + 0x0))->unk3 = r6 >> 8;
}

void sub_800EAAC(void)
{
    s32 i;
    struct UnknownStruct8 *_ewram4 = &(*(struct UnknownStruct8 *)(gSharedMem + 0x4));
...
void shedinja_something(struct Pokemon *pkmn)
{
    ...
    if (GetMonData(pkmn, 11) == SPECIES_SHEDINJA
     && GetMonData(pkmn, 3) != language)
    {
        GetMonData(pkmn, 2, nickname);
        if (StringCompareWithoutExtCtrlCodes(nickname, gUnknown_081F96C8) == 0)
            SetMonData(pkmn, 3, &language);
    }
}
...
void sub_800EC9C(void)
{
    ...
    case 0:
        if (gBattleTypeFlags & 0x0002)
        {
            ...
            {
                ((struct BattleStruct *) (gSharedMem + 0x0))->unk0 = 1;
                ((struct BattleStruct *) (gSharedMem + 0x0))->unk1 = 1;
                sub_800E9EC();
                sub_800EAAC();
                SendBlock(bitmask_all_link_players_but_self(), ((struct BattleStruct *) (gSharedMem + 0x0)), 32);
    ...
    case 1:
        if ((GetBlockReceivedStatus() & 3) == 3)
        {
            ...
            gTasks[taskId].data[3] = ((struct BattleStruct *) (gSharedMem + 0x0))->unk2 | (((struct BattleStruct *) (gSharedMem + 0x0))->unk3 << 8);
...
void sub_800F02C(void)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        gUnknown_02023A00[i].species = GetMonData(&gPlayerParty[i], 11);
        gUnknown_02023A00[i].heldItem = GetMonData(&gPlayerParty[i], 12);
        GetMonData(&gPlayerParty[i], 2, nickname);
        gUnknown_02023A00[i].level = GetMonData(&gPlayerParty[i], 56);
        gUnknown_02023A00[i].hp = GetMonData(&gPlayerParty[i], 57);
        gUnknown_02023A00[i].maxhp = GetMonData(&gPlayerParty[i], 58);
        gUnknown_02023A00[i].status = GetMonData(&gPlayerParty[i], 55);
        gUnknown_02023A00[i].personality = GetMonData(&gPlayerParty[i], 0);
        gUnknown_02023A00[i].gender = GetMonGender(&gPlayerParty[i]);
        StripExtCtrlCodes(nickname);
        gUnknown_02023A00[i].language = GetMonData(&gPlayerParty[i], 3);
...
void sub_800F104(void)
{
    ...
    pSavedCallback = ((MainCallback *)(gSharedMem + 0x160C4));
    pSavedBattleTypeFlags = ((u16 *)(gSharedMem + 0x160C2));
    RunTasks();
    AnimateSprites();
    BuildOamBuffer();
...
void sub_800F298(void)
{
    ...
    case 1:
        if ((GetBlockReceivedStatus() & 0xF) == 0xF)
        {
            ...
            sub_800EB08();
            memcpy(((struct Pokemon *)(gSharedMem + 0x1D000)), gPlayerParty, sizeof(struct Pokemon) * 3);
            taskId = CreateTask(sub_800DE30, 0);
            gTasks[taskId].data[1] = 0x10E;
            gTasks[taskId].data[2] = 0x5A;
            gTasks[taskId].data[5] = 0;
    ...
    case 2:
      step_2:
        if (sub_8007ECC())
        {
            SendBlock(bitmask_all_link_players_but_self(), ((struct Pokemon *)(gSharedMem + 0x1D000)), sizeof(struct Pokemon) * 2);
            gBattleCommunication[0]++;
        }
        break;
    case 3:
    ...
    case 4:
        if (sub_8007ECC())
        {
            SendBlock(bitmask_all_link_players_but_self(), ((struct Pokemon *)(gSharedMem + 0x1D000)) + 2, sizeof(struct Pokemon));
            gBattleCommunication[0]++;
        }
        break;
    case 5:
    ...
    if ((gBattleTypeFlags & 0x908) == 8)
    {
        ...
        for (i = 0; i < gTrainers[trainerNum].partySize; i++)
        {
            ...
            case 0:
            {
                ...
                CreateMon(&party[i], partyData[i].species, partyData[i].level, fixedIV, 1, personalityValue, 2, 0);
                break;
            }
            case 1:
            {
...
void sub_800FCFC(void)
{
    ...
    (*(vu16 *)(0x4000000 + 0x40)) = gUnknown_030042C4;
    (*(vu16 *)(0x4000000 + 0x44)) = gUnknown_03004240;
    (*(vu16 *)(0x4000000 + 0x42)) = gUnknown_03004200;
    (*(vu16 *)(0x4000000 + 0x46)) = gUnknown_03004244;
    LoadOam();
...
void sub_8010384(struct Sprite *sprite)
{
    ...
    if (((struct Struct2017800 *) (gSharedMem + 0x17800))[r6].transformedSpecies != 0)
        species = ((struct Struct2017800 *) (gSharedMem + 0x17800))[r6].transformedSpecies;
    else
        species = sprite->data[2];

    GetMonData(&gEnemyParty[gBattlePartyID[r6]], 0);

    if (species == SPECIES_UNOWN)
    {
        u32 personalityValue = GetMonData(&gEnemyParty[gBattlePartyID[r6]], 0);
        ...
        if (unownForm == 0)
            ...
            unownSpecies = SPECIES_EGG + unownForm;
...
void dp11b_obj_instanciate(u8 bank, u8 b, s8 c, s8 d)
{
    ...
    if (b)
    {
        if (((struct Struct2017810 *) (gSharedMem + 0x17810))[bank].unk0_1)
            return;
    }
    else
    {
        if (((struct Struct2017810 *) (gSharedMem + 0x17810))[bank].unk0_2)
            return;
    }
    ...
    if (b == 1)
    {
        ...
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[bank].unk2 = spriteId;
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[bank].unk0_1 = 1;
        gSprites[spriteId].data[0] = 0x80;
    }
    else
    {
        objectID = gObjectBankIDs[bank];
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[bank].unk3 = spriteId;
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[bank].unk0_2 = 1;
...
void dp11b_obj_free(u8 a, u8 b)
{
    ...
    if (b == 1)
    {
        if (!((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk0_1)
            return;
        r4 = gSprites[((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk2].data[3];
        DestroySprite(&gSprites[((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk2]);
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk0_1 = 0;
    }
    else
    {
        if (!((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk0_2)
            return;
        r4 = gSprites[((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk3].data[3];
        DestroySprite(&gSprites[((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk3]);
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk0_2 = 0;
    }
...
void sub_8010874(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        { r4 = (u8 *)&gDisableStructs[i]; for(j = 0; j < (u32)0x1C; j++) r4[j] = 0; };
        ...
        (*(struct Struct2017100 *)(gSharedMem + 0x17100)).arr[i] = 0;
    }

    for (i = 0; i < 2; i++)
    {
        gSideAffecting[i] = 0;
        { r4 = (u8 *)&gSideTimer[i]; for(j = 0; j < (u32)12; j++) r4[j] = 0; };
    }
    ...
    { r4 = (u8 *)&gWishFutureKnock; for(i = 0; i < (u32)0x2C; i++) r4[i] = 0; };

    gHitMarker = 0;
    if ((gBattleTypeFlags & 0x0002) == 0 && gSaveBlock2.optionsBattleSceneOff == 1)
        gHitMarker = 0x00000080;
    (gSharedMem[0x16084]) = gSaveBlock2.optionsBattleStyle;
    gMultiHitCounter = 0;
    gBattleOutcome = 0;
    gBattleExecBuffer = 0;
    gPaydayMoney = 0;
    (gSharedMem[0x17130]) = 0;
    (gSharedMem[0x17160]) = 0;
    for (i = 0; i < 8; i++)
        gBattleCommunication[i] = 0;
    gPauseCounterBattle = 0;
    gBattleMoveDamage = 0;
    gUnknown_02024DE8 = 0;
    (gSharedMem[0x16002]) = 0;
    (gSharedMem[0x160A1]) = 0;
    gLeveledUpInBattle = 0;
    gAbsentBankFlags = 0;
    (gSharedMem[0x16078]) = 0;
    (gSharedMem[0x16086]) = 0;
    (gSharedMem[0x16087]) = 0;
    (gSharedMem[0x16089]) = gBaseStats[GetMonData(&gEnemyParty[0], 11)].catchRate * 100 / 1275;
    (gSharedMem[0x16088]) = 3;
    (gSharedMem[0x1601B]) = 0;
    (gSharedMem[0x16056]) = 1;

    for (i = 0; i < 8; i++)
    {
        (gSharedMem[0x160AC + i]) = 0;
        (gSharedMem[0x160CC + i]) = 0;
        (gSharedMem[0x160E8 + i]) = 0;
        (gSharedMem[0x160F0 + i]) = 0;
        (gSharedMem[0x16100 + i]) = 0;
        (gSharedMem[0x16108 + i]) = 0;
    }

    (gSharedMem[0x160C8]) = 6;
    (gSharedMem[0x160C9]) = 6;
    (gSharedMem[0x16113]) = 0;
    for (i = 0; i < 11; i++)
...
void SwitchInClearStructs(void)
{
    ...
    if (gBattleMoves[gCurrentMove].effect != EFFECT_BATON_PASS)
    {
        ...
        for (i = 0; i < gNoOfAllBanks; i++)
        {
            ...
            if ((gStatuses3[i] & 0x18) && gDisableStructs[i].bankWithSureHit == gActiveBank)
            {
                gStatuses3[i] &= ~0x18;
    ...
    if (gBattleMoves[gCurrentMove].effect == EFFECT_BATON_PASS)
    {
        gBattleMons[gActiveBank].status2 &= (0x00000007 | 0x00100000 | 0x01000000 | 0x04000000 | 0x10000000);
        gStatuses3[gActiveBank] &= (0x3 | 0x4 | 0x18 | 0x20 | 0x400 | 0x10000 | 0x20000);
    ...
    for (i = 0; i < gNoOfAllBanks; i++)
    {
        ...
        if ((gUnknown_02024AD0[i].unk0 & 0xE000) && (gSharedMem[0x16020 + i]) == gActiveBank)
    ...
    { ptr = (u8 *)&gDisableStructs[gActiveBank]; for(i = 0; i < (u32)0x1C; i++) ptr[i] = 0; };
    ...
    (gSharedMem[0x160AC + 0 + gActiveBank * 2]) = 0;
    (gSharedMem[0x160AC + 1 + gActiveBank * 2]) = 0;
    (gSharedMem[0x16100 + 0 + gActiveBank * 4]) = 0;
    (gSharedMem[0x16100 + 1 + gActiveBank * 4]) = 0;
    (gSharedMem[0x16100 + 2 + gActiveBank * 4]) = 0;
    (gSharedMem[0x16100 + 3 + gActiveBank * 4]) = 0;
    (gSharedMem[0x160E8 + 0 + gActiveBank * 2]) = 0;
    (gSharedMem[0x160E8 + 1 + gActiveBank * 2]) = 0;

    (*(struct Struct2017100 *)(gSharedMem + 0x17100)).arr[gActiveBank] = 0;
...
void UndoEffectsAfterFainting(void)
{
    ...
    for (i = 0; i < gNoOfAllBanks; i++)
    {
        if ((gBattleMons[i].status2 & 0x04000000) && gDisableStructs[i].bankPreventingEscape == gActiveBank)
        ...
        if ((gBattleMons[i].status2 & 0x0000E000) && (gSharedMem[0x16020 + i]) == gActiveBank)
...
void sub_8011384(void)
{
    ...
    if (gBattleExecBuffer == 0)
    {
        for (gActiveBank = 0; gActiveBank < gNoOfAllBanks; gActiveBank++)
        {
            ...
            {
                { ptr = (u8 *)&gBattleMons[gActiveBank]; for(i = 0; i < (u32)0x58; i++) ptr[i] = 0; };
            }
            else
            {
                u8 r0;

                { ptr = (u8 *)&gBattleMons[gActiveBank]; for(i = 0; i < (u32)0x58; i++) ptr[i] = gBattleBufferB[gActiveBank][4 + i]; };
                gBattleMons[gActiveBank].type1 = gBaseStats[gBattleMons[gActiveBank].species].type1;
                gBattleMons[gActiveBank].type2 = gBaseStats[gBattleMons[gActiveBank].species].type2;
                ...
                ((u16 *)(gSharedMem + 0x160BC))[r0] = gBattleMons[gActiveBank].hp;
                for (i = 0; i < 8; i++)
                    gBattleMons[gActiveBank].statStages[i] = 6;
                gBattleMons[gActiveBank].status2 = 0;
            }
            ...
            if (gBattleTypeFlags & 0x0008)
            {
                ...
                if (GetBankSide(gActiveBank) == 1
                 && !(gBattleTypeFlags & (0x0800 | 0x0100 | 0x0002)))
        ...
        if (gBattleTypeFlags & 0x0008)
        {
            for (i = 0; i < 6; i++)
            {
                if (GetMonData(&gEnemyParty[i], 65) == 0
                 || GetMonData(&gEnemyParty[i], 65) == SPECIES_EGG)
                {
            ...
            for (i = 0; i < 6; i++)
            {
                if (GetMonData(&gPlayerParty[i], 65) == 0
                 || GetMonData(&gPlayerParty[i], 65) == SPECIES_EGG)
                {
                    hpStatus[i].hp = 0xFFFF;
                    hpStatus[i].status = 0;
                }
...
void sub_80119B4(void)
{
    if (gBattleExecBuffer == 0)
    {
        ...
        (gSharedMem[0x16058]) = 0;
        (gSharedMem[0x160F9]) = 0;
        (gSharedMem[0x160E6]) = 0;
...
void BattleBeginFirstTurn(void)
{
    ...
    if (gBattleExecBuffer == 0)
    {
        ...
        if ((gSharedMem[0x160E6]) == 0 && AbilityBattleEffects(0, 0, 0, 0xFF, 0) != 0)
        {
            (gSharedMem[0x160E6]) = 1;
            return;
        }
        while ((gSharedMem[0x16058]) < gNoOfAllBanks)
        {
            if (AbilityBattleEffects(0, gTurnOrder[(gSharedMem[0x16058])], 0, 0, 0) != 0)
                r9++;
            (gSharedMem[0x16058])++;
            if (r9 != 0)
                return;
        ...
        if (AbilityBattleEffects(11, 0, 0, 0, 0) != 0)
            return;
        while ((gSharedMem[0x160F9]) < gNoOfAllBanks)
        {
            if (ItemBattleEffects(0, gTurnOrder[(gSharedMem[0x160F9])], 0) != 0)
                r9++;
            (gSharedMem[0x160F9])++;
            if (r9 != 0)
                return;
        ...
        for (i = 0; i < 4; i++)
        {
            (gSharedMem[0x16068 + i]) = 6;
            gActionForBanks[i] = 0xFF;
            gChosenMovesByBanks[i] = 0;
        }
        TurnValuesCleanUp(0);
        SpecialStatusesClear();
        (gSharedMem[0x160A6]) = gAbsentBankFlags;
        ...
        (gSharedMem[0x16000]) = 0;
        (gSharedMem[0x16001]) = 0;
        (gSharedMem[0x16110]) = 0;
        (gSharedMem[0x16111]) = 0;
        (gSharedMem[0x1600C]) = 0;
        (gSharedMem[0x16059]) = 0;
        (gSharedMem[0x1600E]) = 0;
        gBattleMoveFlags = 0;
...
u8 CanRunFromBattle(void)
{
    ...
    {
        (gSharedMem[0x16003]) = i - 1;
        gLastUsedAbility = gBattleMons[i - 1].ability;
        gBattleCommunication[5] = 2;
        return 2;
    }
    if ((gBattleMons[gActiveBank].status2 & (0x04000000 | 0x0000E000)) || (gStatuses3[gActiveBank] & 0x400))
    {
...
void sub_8012258(u8 a)
{
    ...
    for (i = 0; i < 3; i++)
        gUnknown_02038470[i] = (gSharedMem[0x1606C + i + a * 3]);
    r4 = pokemon_order_func(gBattlePartyID[a]);
    r1 = pokemon_order_func((gSharedMem[0x16068 + a]));
    sub_8094C98(r4, r1);
    if (gBattleTypeFlags & 0x0001)
    {
        for (i = 0; i < 3; i++)
        {
            (gSharedMem[0x1606C + i + a * 3]) = gUnknown_02038470[i];
            (gSharedMem[0x1606C + i + (a ^ 2) * 3]) = gUnknown_02038470[i];
        }
    }
    else
    {
