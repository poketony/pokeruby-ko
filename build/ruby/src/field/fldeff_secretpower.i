# 1 "src/field/fldeff_secretpower.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/fldeff_secretpower.c"
...
# 2 "src/field/fldeff_secretpower.c" 2
...
# 3 "src/field/fldeff_secretpower.c" 2
...
# 4 "src/field/fldeff_secretpower.c" 2
...
# 5 "src/field/fldeff_secretpower.c" 2
...
# 6 "src/field/fldeff_secretpower.c" 2
...
# 7 "src/field/fldeff_secretpower.c" 2
# 1 "include/metatile_behaviors.h" 1
# 8 "src/field/fldeff_secretpower.c" 2
...
# 9 "src/field/fldeff_secretpower.c" 2
...
# 10 "src/field/fldeff_secretpower.c" 2
# 1 "include/rom6.h" 1
...
# 11 "src/field/fldeff_secretpower.c" 2
...
# 12 "src/field/fldeff_secretpower.c" 2
...
# 13 "src/field/fldeff_secretpower.c" 2
# 1 "include/songs.h" 1
...
# 14 "src/field/fldeff_secretpower.c" 2
# 1 "include/sound.h" 1
...
# 15 "src/field/fldeff_secretpower.c" 2
...
bool8 SetUpFieldMove_SecretPower(void)
{
    ...
    if (MetatileBehavior_IsSecretBaseCave(behavior) == 1)
    {
        sub_80C6264();
    ...
    if (MetatileBehavior_IsSecretBaseTree(behavior) == 1)
    {
        sub_80C6264();
        gFieldCallback = FieldCallback_Teleport;
    ...
    if (MetatileBehavior_IsSecretBaseShrub(behavior) == 1)
    {
        sub_80C6264();
        gFieldCallback = FieldCallback_Teleport;
