...
# 14 "src/field/shop.c" 2
# 1 "include/sprite.h" 1
# 15 "src/field/shop.c" 2
...
# 16 "src/field/shop.c" 2
# 1 "include/task.h" 1
# 17 "src/field/shop.c" 2
# 1 "include/tv.h" 1
...
# 29 "src/field/shop.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 30 "src/field/shop.c" 2
...
__attribute__((section("ewram_data"))) u32 gMartTotalCost = 0;
__attribute__((section("ewram_data"))) s16 gUnknown_020386A4[16][4] = {0};
__attribute__((section("ewram_data"))) struct ItemSlot gUnknown_02038724[3] = {0};
__attribute__((section("ewram_data"))) u8 gUnknown_02038730 = 0;
__attribute__((section("ewram_data"))) u8 gUnknown_02038731 = 0;
...
static const u8 gUnknown_083CC6E8[] = {0, 1, 2};
static const u8 gUnknown_083CC6EB[] = {0, 2};
...
void sub_80B2E38(u8 var)
{
    ...
    {
        if (gMartInfo.cursor != gMartInfo.numChoices)
        {
            PlaySE(SE_SELECT);
            gMartInfo.cursor = MoveMenuCursor(1);
        }
...
void HandleShopMenuQuit(u8 taskId)
{
    ...
    MenuZeroFillWindowRect(0, 0, 15, 8);
    sub_80BE3BC();
...
void sub_80B30AC(void)
{
    ...
    addr = (void *)(0x6000000 + 0xE800);
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(tempArr); dmaRegs[1] = (vu32)(addr); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x800)/(16/8))); dmaRegs[2]; };
    tempArr2 = gBGTilemapBuffers[2];
    addr2 = (void *)(0x6000000 + 0xE000);
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(tempArr2); dmaRegs[1] = (vu32)(addr2); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x800)/(16/8))); dmaRegs[2]; };
    tempArr3 = gBGTilemapBuffers[3];
    addr3 = (void *)(0x6000000 + 0xF000);
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(tempArr3); dmaRegs[1] = (vu32)(addr3); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x800)/(16/8))); dmaRegs[2]; };
}
...
void BuyMenuDrawGraphics(void)
{
    ...
    sub_80F9438();
    remove_some_task();
    (*(vu16 *)(0x4000000 + 0x14)) = (zero2 = 0);
    (*(vu16 *)(0x4000000 + 0x16)) = zero2;
    (*(vu16 *)(0x4000000 + 0x18)) = zero2;
    (*(vu16 *)(0x4000000 + 0x1a)) = zero2;
    (*(vu16 *)(0x4000000 + 0x1c)) = zero2;
    (*(vu16 *)(0x4000000 + 0x1e)) = zero2;
    gPaletteFade.bufferTransferDisabled = 1;
    addr = (void*)0x7000000;
    {
    register const u32 zero asm("r6") = 0;
    { vu32 tmp = (vu32)(zero); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(addr); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x400)/(32/8))); dmaRegs[2]; }; };
    LZDecompressVram(gBuyMenuFrame_Gfx, (void*)(0x6000000 + 0x7C00));
    LZDecompressWram(gBuyMenuFrame_Tilemap, (&gSharedMem[0x18000]));
...
void sub_80B3720(void)
{
    ...
    for (i = 0; i < 0x400; i++)
    {
        if (((u16 *)(gSharedMem + 0x18000))[i] != 0)
            gBGTilemapBuffers[1][i] = ((u16 *)(gSharedMem + 0x18000))[i] + 0xC3E0;
    }
}
...
void sub_80B379C(void)
{
    ...
    for (i = 0; i < 8; i++)
        for (j = 0; j < 14; j++)
            gBGTilemapBuffers[1][32 * (i + 12) + j] = ((u16 *)(gSharedMem + 0x18300))[32 * i + j] + 0xC3E0;
}
...
void sub_80B3930(u16 itemId, u8 var2, bool32 hasControlCode)
{
 ...
 if (sSelect == 1)
 {
  ...
  MenuPrint(cursor, 14, var2);
    ...
    {
        sub_80B7B34(0x19, var2, hasControlCode);
    }
    else
    {
...
void sub_80B39D0(int var1, int var2, bool32 hasControlCode)
{
 ...
 SetCustomFont(1);
    ...
    {
        MenuFillWindowRectWithBlankTile(15, (i << 1) + 2, 0x1C, (i << 1) + 3);
        MenuPrint(gOtherText_CancelNoTerminator, 15, (i << 1) + 2);
    }
...
void sub_80B3A70(void)
{
 SetCustomFont(1);
    ...
    {
        sub_8072AB0(gOtherText_QuitShopping, 0x8, 0x68, 0x68, 0x30, 0);
    }
 SetCustomFont(0);
}
...
void sub_80B3AEC(u8 taskId)
{
    if (gMain.newKeys & 0x0001 || gMain.newKeys & 0x0002)
    {
        ...
        if (gMartInfo.itemList[gMartInfo.choicesAbove + gMartInfo.cursor] == ITEM_POKE_BALL && gTasks[taskId].data[1] >= 10 && AddBagItem(ITEM_PREMIER_BALL, 1) == 1)
...
void sub_80B3BF4(u8 taskId)
{
    ...
    sub_80A3FA0(gBGTilemapBuffers[1], 8, 9, 5, 4, 0);
    sub_80B379C();
    sub_80B3420();
...
void sub_80B3D38(u8 taskId)
{
    ...
    sub_80A3FA0(gBGTilemapBuffers[1], 8, 9, 5, 4, 0xC3E1);
...
void sub_80B3D7C(u8 taskId)
{
    sub_80B39D0(gMartInfo.cursor, gMartInfo.cursor, 0);
    MenuZeroFillWindowRect(0x7, 0x8, 0xD, 0xD);
    sub_80A3FA0(gBGTilemapBuffers[1], 0x8, 0x9, 0x5, 0x4, 0);
    sub_80B4378(taskId);
}

void sub_80B3DC8(u8 taskId)
{
    if (sub_80A52C4(taskId, gMartInfo.curItemCount) == 1)
        sub_80B37F8(taskId);
 ...
 sSelect = 0;
    ...
    {
        gMartTotalCost = (ItemId_GetPrice(gMartInfo.itemList[gMartInfo.choicesAbove + gMartInfo.cursor]) >> GetPriceReduction(1)) * gTasks[taskId].data[1];
...
# 893 "src/field/shop.c"
}
# 940 "src/field/shop.c"
__attribute__((naked))
...
# 1031 "src/field/shop.c"
}


void sub_80B40E8(u8 taskId)
{
    if (!gPaletteFade.active)
    {
  sSelect = 0;
        if ((gMain.newAndRepeatedKeys & 0x00F0) == 0x0040)
        {
            ...
            {
    MenuFillWindowRectWithBlankTile(14, 4, 14, 15);
                if (gMartInfo.choicesAbove == 0)
                    return;
    ...
    sSelect = 1;
                ...
                if (gMartInfo.martType == MART_TYPE_0)
                {
                    gMartTotalCost = (ItemId_GetPrice(gMartInfo.itemList[gMartInfo.choicesAbove + gMartInfo.cursor]) >> GetPriceReduction(1));
                    if (!IsEnoughMoney(gSaveBlock1.money, gMartTotalCost))
                    {
                        DisplayItemMessageOnField(taskId, gOtherText_NotEnoughMoney, sub_80B3BD0, 0xC3E1);
                    }
