...
# 2 "src/field/fldeff_cut.c" 2
# 1 "include/fldeff_cut.h" 1
...
# 9 "src/field/fldeff_cut.c" 2
# 1 "include/metatile_behaviors.h" 1
# 10 "src/field/fldeff_cut.c" 2
...
# 16 "src/field/fldeff_cut.c" 2
# 1 "include/sprite.h" 1
# 17 "src/field/fldeff_cut.c" 2
# 1 "include/task.h" 1
# 18 "src/field/fldeff_cut.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 19 "src/field/fldeff_cut.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 20 "src/field/fldeff_cut.c" 2
...
bool8 SetUpFieldMove_Cut(void)
{
    ...
    if(npc_before_player_of_type(0x52) == 1)
    {
...
bool8 FldEff_CutGrass(void)
{
    ...
    for(i = 0; i < 8; i++)
    {
        (gSharedMem + 0x1FFF0)[i] = CreateSprite((struct SpriteTemplate *)&gSpriteTemplate_CutGrass,
        gSprites[gPlayerAvatar.spriteId].oam.x + 8, gSprites[gPlayerAvatar.spriteId].oam.y + 20, 0);
        gSprites[(gSharedMem + 0x1FFF0)[i]].data[2] = 32 * i;
    }
    return 0;
}
...
void objc_8097BBC(struct Sprite *sprite)
{
    ...
    sprite->data[0] += ((tempdata2 = sprite->data[3]) << 16 >> 18) + 1;
...
void sub_80A2AB8(void)
{
    ...
    for (i = 1; i < 8; i++)
        DestroySprite(&gSprites[(gSharedMem + 0x1FFF0)[i]]);
    FieldEffectStop(&gSprites[(gSharedMem + 0x1FFF0)[0]], FLDEFF_CUT_GRASS);
    sub_8064E2C();
