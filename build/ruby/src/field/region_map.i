...
# 10 "src/field/region_map.c" 2
# 1 "include/pokemon_menu.h" 1



# 1 "include/menu.h" 1
# 5 "include/pokemon_menu.h" 2
...
# 15 "src/field/region_map.c" 2
# 1 "include/sprite.h" 1
# 16 "src/field/region_map.c" 2
...
# 18 "src/field/region_map.c" 2
# 1 "include/text.h" 1
# 19 "src/field/region_map.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 20 "src/field/region_map.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 21 "src/field/region_map.c" 2
# 121 "src/field/region_map.c"
enum
{
    INPUT_EVENT_NONE,
    INPUT_EVENT_DPAD,
...
# 1 "src/field/../data/region_map_layout.h" 1
# 25 "src/field/../data/region_map_layout.h"
static const u8 sRegionMapLayout[] =
{
    0x58, 0x1D, 0x1D, 4, 0x1C, 0x1C, 0x1C, 0x1C, 0x1A, 0x58, 0x58, 0x22, 11, 0x23, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58,
    ...
    0x1E, 0x58, 0x58, 0x58, 0x58, 3, 0x1B, 0x1B, 0x1A, 0x58, 0x58, 0x22, 0x58, 0x23, 0x24, 0x24, 0x24, 0x24, 12, 12, 0x27, 0x27, 0x27, 0x27, 0x28, 0x28, 0x58, 0x58,
    ...
    10, 0x1F, 0x1F, 0x1F, 0x1F, 0x58, 0x58, 0x58, 0x1A, 0x58, 0x58, 0x22, 0x58, 0x58, 0x58, 0x58, 0x25, 0x58, 0x58, 0x58, 0x27, 0x27, 0x27, 0x27, 13, 13, 0x58, 0x58,
    10, 0x58, 0x58, 0x58, 5, 0x20, 0x20, 0x20, 9, 9, 0x21, 0x21, 0x26, 0x26, 0x26, 0x26, 0x26, 0x58, 0x58, 0x58, 0x29, 0x29, 0x29, 0x2A, 0x2A, 0x2A, 0x58, 0x58,
    0x13, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x19, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x29, 14, 0x29, 0x2A, 0x2A, 0x2A, 0x58, 0x58,
    0x13, 0x58, 0x58, 0x58, 0x12, 0x12, 0x12, 0x12, 0x19, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x29, 0x29, 0x29, 0x2A, 0x2A, 0x2A, 0x58, 15,
    0x13, 7, 0x11, 0x11, 1, 0x58, 0x58, 0x58, 0x19, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x2B, 0x2B, 0x2B, 0x2B, 15,
    0x14, 0x58, 0x58, 0x58, 0x10, 0x58, 0x58, 0x58, 8, 0x31, 0x31, 0x31, 0x30, 0x30, 0x30, 0x2F, 0x2F, 6, 0x2E, 0x2E, 0x2E, 0x2D, 0x2D, 0x2D, 0x2C, 0x2C, 0x58, 0x58,
    0x14, 0x58, 0x58, 0x58, 0, 0x58, 0x58, 0x58, 8, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58,
    ...
    0x58, 0x58, 2, 0x16, 0x16, 0x16, 0x17, 0x17, 0x18, 0x58, 0x58, 0x58, 0x49, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58,
};
# 145 "src/field/region_map.c" 2
# 1 "src/field/../data/region_map_names.h" 1
...
const u8 gMapName_Route101[] = _("101번 도로");
const u8 gMapName_Route102[] = _("102번 도로");
const u8 gMapName_Route103[] = _("103번 도로");
const u8 gMapName_Route104[] = _("104번 도로");
const u8 gMapName_Route105[] = _("105번 수로");
const u8 gMapName_Route106[] = _("106번 수로");
const u8 gMapName_Route107[] = _("107번 수로");
const u8 gMapName_Route108[] = _("108번 수로");
const u8 gMapName_Route109[] = _("109번 수로");
const u8 gMapName_Route110[] = _("110번 도로");
const u8 gMapName_Route111[] = _("111번 도로");
const u8 gMapName_Route112[] = _("112번 도로");
const u8 gMapName_Route113[] = _("113번 도로");
const u8 gMapName_Route114[] = _("114번 도로");
const u8 gMapName_Route115[] = _("115번 도로");
const u8 gMapName_Route116[] = _("116번 도로");
const u8 gMapName_Route117[] = _("117번 도로");
const u8 gMapName_Route118[] = _("118번 도로");
const u8 gMapName_Route119[] = _("119번 도로");
const u8 gMapName_Route120[] = _("120번 도로");
const u8 gMapName_Route121[] = _("121번 도로");
const u8 gMapName_Route122[] = _("122번 수로");
const u8 gMapName_Route123[] = _("123번 도로");
const u8 gMapName_Route124[] = _("124번 수로");
const u8 gMapName_Route125[] = _("125번 수로");
const u8 gMapName_Route126[] = _("126번 수로");
const u8 gMapName_Route127[] = _("127번 수로");
const u8 gMapName_Route128[] = _("128번 수로");
const u8 gMapName_Route129[] = _("129번 수로");
const u8 gMapName_Route130[] = _("130번 수로");
const u8 gMapName_Route131[] = _("131번 수로");
const u8 gMapName_Route132[] = _("132번 수로");
const u8 gMapName_Route133[] = _("133번 수로");
const u8 gMapName_Route134[] = _("134번 수로");
...
bool8 sub_80FA940(void)
{
    ...
    {
    case 0:
        LZ77UnCompVram(sRegionMapBkgnd_ImageLZ, (void *)(0x6000000 + 0x8000));
        break;
    case 1:
        LZ77UnCompVram(sRegionMapBkgnd_TilemapLZ, (void *)(0x6000000 + 0xE000));
        break;
    case 2:
...
static u8 sub_80FAD04(void)
{
    ...
    gRegionMap->unk6A = 0;
    gRegionMap->unk68 = 0;
    if ((gMain.heldKeys & 0x0040) && gRegionMap->scrollY > -52)
    {
        gRegionMap->unk68 = -1;
        event = INPUT_EVENT_DPAD;
    }
    if ((gMain.heldKeys & 0x0080) && gRegionMap->scrollY < 60)
    {
        gRegionMap->unk68 = 1;
        event = INPUT_EVENT_DPAD;
    }
    if ((gMain.heldKeys & 0x0020) && gRegionMap->scrollX > -44)
    {
        gRegionMap->unk6A = -1;
        event = INPUT_EVENT_DPAD;
    }
    if ((gMain.heldKeys & 0x0010) && gRegionMap->scrollX < 172)
    {
        gRegionMap->unk6A = 1;
        event = INPUT_EVENT_DPAD;
    }
...
u8 sub_80FAFC0(void)
{
    ...
    if (gRegionMap->unk6E == 16)
    {
        ...
        gRegionMap->unk4C = (gRegionMap->zoomed == 0) ? (128 << 8) : (256 << 8);
        gRegionMap->zoomed = !gRegionMap->zoomed;
        gRegionMap->inputCallback = (gRegionMap->zoomed == 0) ? sub_80FAB78 : sub_80FAD04;
...
void UpdateRegionMapVideoRegs(void)
{
    ...
    {
        (*(vu16 *)(0x4000000 + 0x20)) = gRegionMap->unk2C;
        (*(vu16 *)(0x4000000 + 0x22)) = gRegionMap->unk34;
        (*(vu16 *)(0x4000000 + 0x24)) = gRegionMap->unk30;
        (*(vu16 *)(0x4000000 + 0x26)) = gRegionMap->unk38;
        (*(vu32 *)(0x4000000 + 0x28)) = gRegionMap->bg2x;
        (*(vu32 *)(0x4000000 + 0x2c)) = gRegionMap->bg2y;
...
static void InitializeCursorPosition(void)
{
    ...
    case 5:
        ...
        x = gSaveBlock1.pos.x;
        y = gSaveBlock1.pos.y;
        if (gRegionMap->mapSectionId == 0x45)
    ...
    case 7:
        {
            ...
            gRegionMap->mapSectionId = gMapHeader.regionMapSectionId;
            if (gRegionMap->mapSectionId != 0x57)
            {
    ...
    gRegionMap->cursorPosX = gRegionMapLocations[gRegionMap->mapSectionId].x + x + 1;
    gRegionMap->cursorPosY = gRegionMapLocations[gRegionMap->mapSectionId].y + y + 2;
}
...
static void sub_80FB600(void)
{
    ...
    {
    case 1:
        gRegionMap->mapSectionId = 8;
        break;
    case 2:
        gRegionMap->mapSectionId = 12;
        break;
    case 3:
        gRegionMap->mapSectionId = 0x27;
        break;
    case 4:
        gRegionMap->mapSectionId = 0x2E;
        break;
    default:
    case 0:
        {
...
static u16 sub_80FB9C0(u16 mapSectionId)
{
    ...
    for (i = 0; gUnknown_083E7684[i][0] != 0x58; i++)
    {
...
static void sub_80FBA18(void)
{
    ...
    if (gRegionMap->mapSectionId == 0x58)
    {
...
{
    {sEverGrandeCityAreaNames, 15, 0x854},
};
...
void CB2_InitFlyRegionMap(void)
{
    ...
    case 2:
        ...
        break;
    case 3:
        InitRegionMap(&(*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap, 0);
        CreateRegionMapCursor(0, 0);
        CreateRegionMapPlayerIcon(1, 1);
        (*(struct UnknownStruct3 *)(gSharedMem + 0x0)).unk6 = (*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionId;
        StringFill((gSharedMem + 0xA48), 0x00, 12);
        PrintFlyTargetName();
        break;
    case 4:
        LZ77UnCompVram(sFlyRegionMapFrame_ImageLZ, (void *)(0x6000000 + 0xC000));
        break;
    case 5:
        LZ77UnCompVram(sFlyRegionMapFrame_TilemapLZ, (void *)(0x6000000 + 0xF000));
        break;
    case 6:
        LoadPalette(sFlyRegionMapFrame_Pal, 16, 32);
        MenuPrint(gOtherText_FlyToWhere, 1, 18);
        break;
    case 7:
...
static void CB2_FlyRegionMap(void)
{
    (*(struct UnknownStruct3 *)(gSharedMem + 0x0)).unk0();
    AnimateSprites();
    BuildOamBuffer();
}
...
static void sub_80FC244(void (*func)(void))
{
    (*(struct UnknownStruct3 *)(gSharedMem + 0x0)).unk0 = func;
    (*(struct UnknownStruct3 *)(gSharedMem + 0x0)).unk4 = 0;
}

static void PrintFlyTargetName(void)
{
    if ((*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.unk16 == 2 || (*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.unk16 == 4)
    {
        u16 i = 0;
        int zero;

        for (i = 0; i < (sizeof(sUnknown_083E79C0) / sizeof((sUnknown_083E79C0)[0])); i++)
        {
            const struct UnknownStruct4 *r4 = &sUnknown_083E79C0[i];

            if ((*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionId == r4->mapSectionId)
            {
                if (FlagGet(r4->flag))
                {
                    MenuDrawTextWindow(16, 14, 29, 19);
                    MenuPrint((*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionName, 17, 15);
                    MenuPrint_RightAligned(r4->unk0[(*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.everGrandeCityArea], 29, 17);
                    return;
                }
                break;
            }
        ...
        if (zero == 0)
        {
            ...
            MenuPrint((*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionName, 17, 17);
    ...
    {
        MenuDrawTextWindow(16, 16, 29, 19);
        MenuPrint((gSharedMem + 0xA48), 17, 17);
        MenuZeroFillWindowRect(16, 14, 29, 15);
    }
}
...
static void CreateFlyTargetGraphics(void)
{
    ...
    LZ77UnCompWram(sFlyTargetIcons_ImageLZ, (gSharedMem + 0x888));
    spriteSheet.data = (gSharedMem + 0x888);
...
static void CreateSpecialAreaFlyTargetIcons(void)
{
    ...
    for (i = 0; sSpecialFlyAreas[i][1] != 0x58; i++)
    {
        u16 x;
        u16 y;
        u16 width;
...
static void SpriteCB_FlyTargetIcons(struct Sprite *sprite)
{
    ...
    if ((*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionId == sprite->data[0])
    {
...
static void sub_80FC5B4(void)
{
    switch ((*(struct UnknownStruct3 *)(gSharedMem + 0x0)).unk4)
    {
    case 0:
        BeginNormalPaletteFade(0xFFFFFFFF, 0, 16, 0, 0);
        (*(struct UnknownStruct3 *)(gSharedMem + 0x0)).unk4++;
        break;
    case 1:
...
static void sub_80FC600(void)
{
    if ((*(struct UnknownStruct3 *)(gSharedMem + 0x0)).unk4 == 0)
    {
        switch (sub_80FAB60())
        {
...
static void sub_80FC69C(void)
{
    ...
    case 1:
        ...
        if ((gSharedMem[0xA6E]) != 0)
        {
            switch ((*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionId)
            {
            case 0x49:
                sub_8053538(22);
                break;
            ...
            case 0:
                ...
                break;
            case 15:
                sub_8053538((FlagGet(0x854) && (*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.everGrandeCityArea == 0) ? 20 : 11);
                break;
            default:
                if (sUnknown_083E7920[(*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionId][2] != 0)
                    sub_8053538(sUnknown_083E7920[(*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionId][2]);
                else
                    warp1_set_2(sUnknown_083E7920[(*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionId][0], sUnknown_083E7920[(*(struct UnknownStruct3 *)(gSharedMem + 0x0)).regionMap.mapSectionId][1], -1);
                break;
            }
            sub_80865BC();
        }
