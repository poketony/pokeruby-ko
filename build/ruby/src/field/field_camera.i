...
# 7 "src/field/field_camera.c" 2
# 1 "include/sprite.h" 1
# 8 "src/field/field_camera.c" 2
# 1 "include/text.h" 1
# 77 "include/text.h"
struct WindowConfig
{
...
void move_tilemap_camera_to_upper_left_corner(void)
{
    ...
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, gBGTilemapBuffers[2], 0x00000000 | 0x01000000 | ((0x800)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, gBGTilemapBuffers[1], 0x00000000 | 0x01000000 | ((0x800)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(0x3014); CpuSet((void *)&tmp, gBGTilemapBuffers[3], 0x00000000 | 0x01000000 | ((0x800)/(16/8) & 0x1FFFFF)); };
}
...
void sub_8057A58(void)
{
    ...
    *gBGVOffsetRegs[3] = gUnknown_03000590.unk1 + gUnknown_0300059A + 8;
    ...
    {
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gBGTilemapBuffers[1]); dmaRegs[1] = (vu32)((void *)(0x6000000 + 0xE800)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x800)/(16/8))); dmaRegs[2]; };
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gBGTilemapBuffers[2]); dmaRegs[1] = (vu32)((void *)(0x6000000 + 0xE000)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x800)/(16/8))); dmaRegs[2]; };
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gBGTilemapBuffers[3]); dmaRegs[1] = (vu32)((void *)(0x6000000 + 0xF000)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x800)/(16/8))); dmaRegs[2]; };
        gUnknown_03000590.unk4 = 0;
    }
}
...
void ResetCameraUpdateInfo(void)
{
    ...
    gUnknown_03004880.callback = ((void *)0);
}
...
void CameraUpdate(void)
{
    ...
    if (gUnknown_03004880.callback != ((void *)0))
