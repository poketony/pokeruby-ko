# 1 "src/field/fldeff_softboiled.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/fldeff_softboiled.c"
...
# 2 "src/field/fldeff_softboiled.c" 2
# 1 "include/fldeff_softboiled.h" 1



bool8 SetUpFieldMove_SoftBoiled(void);
void sub_8133D28(u8 taskid);
# 3 "src/field/fldeff_softboiled.c" 2
# 1 "include/menu.h" 1
...
# 4 "src/field/fldeff_softboiled.c" 2
...
# 5 "src/field/fldeff_softboiled.c" 2
# 1 "include/pokemon.h" 1
# 6 "src/field/fldeff_softboiled.c" 2
...
# 7 "src/field/fldeff_softboiled.c" 2
# 1 "include/songs.h" 1
...
# 8 "src/field/fldeff_softboiled.c" 2
# 1 "include/sound.h" 1
...
# 9 "src/field/fldeff_softboiled.c" 2
# 1 "include/sprite.h" 1
# 10 "src/field/fldeff_softboiled.c" 2
...
# 11 "src/field/fldeff_softboiled.c" 2
# 1 "include/task.h" 1
# 12 "src/field/fldeff_softboiled.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 13 "src/field/fldeff_softboiled.c" 2
...
bool8 SetUpFieldMove_SoftBoiled(void) {
    ...
    maxHp = GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 58);
    hp = GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 57);
...
void sub_8133D28(u8 taskid) {
    (*(struct Struct2001000 *)(gSharedMem + 0x1000)).unkC = sub_8133D50;
    (*(struct Struct201B000 *)(gSharedMem + 0x1B000)).unk272 = 3;
...
static void sub_8133D50(u8 taskId) {
    ...
    unk1 = sprites[(*(struct Struct2001000 *)(gSharedMem + 0x1000)).unk1].data[0];
    unk2 = sprites[(*(struct Struct2001000 *)(gSharedMem + 0x1000)).unk2].data[0];
    ...
    (*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk0 = &gPlayerParty[sprites[(*(struct Struct2001000 *)(gSharedMem + 0x1000)).unk2].data[0]];
    hp = GetMonData((*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk0, 57);

    if (hp == 0 || unk1 == unk2 || GetMonData((*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk0, 58) == hp)
    {
        sub_8133EB8(taskId);
        return;
    }
    ...
    (*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk5 = gSprites[(*(struct Struct2001000 *)(gSharedMem + 0x1000)).unk1].data[0];

    pokemon = &gPlayerParty[(*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk5];
    (*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk0 = pokemon;
    (*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk6 = 0;
    (*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unkC = -0x8000;
    (*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk10 = sub_8133EF8;


    gTasks[taskId].data[10] = GetMonData((*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk0, 58);
    gTasks[taskId].data[11] = GetMonData((*(struct Struct201C000 *)(gSharedMem + 0x1C000)).unk0, 57);
    gTasks[taskId].data[12] = gTasks[taskId].data[10] / 5;

    sub_806D5A4();
    gTasks[taskId].func = sub_806FA18;
    (*(struct Struct201B000 *)(gSharedMem + 0x1B000)).unk282 = gTasks[taskId].data[11];
}
...
static void sub_8133EF8(void) {
    sub_806CCE4();
    (*(struct Struct201B000 *)(gSharedMem + 0x1B000)).unk261 = 2;
    DestroySprite(&gSprites[(*(struct Struct2001000 *)(gSharedMem + 0x1000)).unk1]);
    MenuZeroFillWindowRect(3, 14, 26, 19);
    PrintPartyMenuPromptText(0, 0);
    SwitchTaskToFollowupFunc((*(struct Struct2001000 *)(gSharedMem + 0x1000)).unk0);
}
