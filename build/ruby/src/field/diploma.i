...
# 2 "src/field/diploma.c" 2
# 1 "include/diploma.h" 1



void CB2_ShowDiploma(void);
# 3 "src/field/diploma.c" 2
# 1 "include/main.h" 1
...
# 8 "src/field/diploma.c" 2
# 1 "include/sprite.h" 1
# 9 "src/field/diploma.c" 2
...
# 11 "src/field/diploma.c" 2
# 1 "include/task.h" 1
# 12 "src/field/diploma.c" 2
# 1 "include/text.h" 1
# 13 "src/field/diploma.c" 2
...
void CB2_ShowDiploma(void)
{
    ...
    LZ77UnCompVram(gDiplomaTiles, (void *)0x6000000);
    LZ77UnCompVram(gDiplomaTilemap, (void *)(0x6000000 + 0x3000));
    ...
    (*(vu16 *)(0x4000000 + 0xe)) = (3) | ((0) << 2) | ((6) << 8) | 0x0000 | 0x4000;
