# 1 "src/field/field_message_box.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/field_message_box.c"
...
# 2 "src/field/field_message_box.c" 2
...
# 3 "src/field/field_message_box.c" 2
# 1 "include/menu.h" 1
...
# 4 "src/field/field_message_box.c" 2
...
# 5 "src/field/field_message_box.c" 2
# 1 "include/task.h" 1
# 6 "src/field/field_message_box.c" 2
# 1 "include/text.h" 1
# 7 "src/field/field_message_box.c" 2
...
# 8 "src/field/field_message_box.c" 2

static __attribute__((section("ewram_data"))) struct Window gFieldMessageBoxWindow = {0};
...
static void PrintFieldMessage(const u8 *message)
{
    ...
    sub_8002EB0(&gFieldMessageBoxWindow, gStringVar4, gMenuTextTileOffset, 4, 15);
