...
static const struct Landmark **GetLandmarks(u8 mapSection, u8 id)
{
    ...
    for (; gLandmarkLists[i].mapSection != 0x58; i++)
    {
    ...
    if (gLandmarkLists[i].mapSection == 0x58)
        return ((void *)0);
