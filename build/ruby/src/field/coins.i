...
void PrintCoins(s32 coins, u8 b, u8 x, u8 y)
{
    ...
    MenuPrint(gOtherText_Coins2, x + 2, y);
}
...
bool8 GiveCoins(u16 coins)
{
    ...
    if (gSaveBlock1.coins > (u16)newCoins)
        gSaveBlock1.coins = 9999;
    else
    {
        gSaveBlock1.coins = newCoins;
        if ((u16)newCoins > 9999)
            gSaveBlock1.coins = 9999;
    }
    return 1;
}
