# 1 "src/field/field_region_map.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/field_region_map.c"
...
# 2 "src/field/field_region_map.c" 2
...
# 3 "src/field/field_region_map.c" 2
# 1 "include/main.h" 1
...
# 4 "src/field/field_region_map.c" 2
# 1 "include/menu.h" 1
...
# 5 "src/field/field_region_map.c" 2
...
# 6 "src/field/field_region_map.c" 2
...
# 7 "src/field/field_region_map.c" 2
# 1 "include/sprite.h" 1
# 8 "src/field/field_region_map.c" 2
...
# 9 "src/field/field_region_map.c" 2
# 1 "include/text.h" 1
# 10 "src/field/field_region_map.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 11 "src/field/field_region_map.c" 2
...
void FieldInitRegionMap(MainCallback callback)
{
    ...
    (*(struct UnkStruct *)(gSharedMem + 0x0)).unk888 = 0;
    (*(struct UnkStruct *)(gSharedMem + 0x0)).callback = callback;
...
void CB2_FieldInitRegionMap(void)
{
    ...
    InitRegionMap((void *)&(*(struct UnkStruct *)(gSharedMem + 0x0)).unk8, 0);
...
void sub_813EFDC(void)
{
    switch ((*(struct UnkStruct *)(gSharedMem + 0x0)).unk888)
    {
    case 0:
        (*(vu16 *)(0x4000000 + 0x0)) = 0x0001 | 0x0040 | 0x0100 | 0x0400 | 0x1000;
        (*(struct UnkStruct *)(gSharedMem + 0x0)).unk888++;
        break;
    case 1:
    ...
    case 4:
        if (!gPaletteFade.active)
        {
            ...
            SetMainCallback2((*(struct UnkStruct *)(gSharedMem + 0x0)).callback);
        }
        break;
    }
}
...
void sub_813F0C8(void)
{
    ...
    if ((*(struct UnkStruct *)(gSharedMem + 0x0)).unk8.unk16)
        MenuPrint((*(struct UnkStruct *)(gSharedMem + 0x0)).unk8.str, 17, 17);
}
