...
# 4 "src/field/field_tasks.c" 2
# 1 "include/vars.h" 1
# 5 "src/field/field_tasks.c" 2
# 1 "include/bike.h" 1
...
void ActivatePerStepCallback(u8 callback)
{
    ...
    if (taskId != 0xff)
    {
        ...
        if (callback >= (sizeof(gUnknown_08376364) / sizeof((gUnknown_08376364)[0])))
        {
            *dataStart = 0;
        }
        else
    ...
    switch (data[1])
    {
        ...
        case 1:
            if (x != data[2] || y != data[3])
            {
                ...
                {
                    sub_80696C0(data[2], data[3], 1);
                    sub_8069708(data[2], data[3], 0);
                    data[4] = data[2];
                    data[5] = data[3];
                    data[1] = 2;
                    data[6] = 8;
