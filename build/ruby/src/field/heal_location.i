...
# 4 "src/field/heal_location.c" 2



static const struct HealLocation sHealLocations[] =
{
    {1, MAP_ID_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F, 4, 2},
    {1, MAP_ID_LITTLEROOT_TOWN_MAYS_HOUSE_2F, 4, 2},
    {0, MAP_ID_PETALBURG_CITY, 20, 17},
    {0, MAP_ID_SLATEPORT_CITY, 19, 20},
    {0, MAP_ID_MAUVILLE_CITY, 22, 6},
    {0, MAP_ID_RUSTBORO_CITY, 16, 39},
    {0, MAP_ID_FORTREE_CITY, 5, 7},
    {0, MAP_ID_LILYCOVE_CITY, 24, 15},
    {0, MAP_ID_MOSSDEEP_CITY, 28, 17},
    {0, MAP_ID_SOOTOPOLIS_CITY, 43, 32},
    {0, MAP_ID_EVER_GRANDE_CITY, 27, 49},
    {0, MAP_ID_LITTLEROOT_TOWN, 5, 9},
    {0, MAP_ID_LITTLEROOT_TOWN, 14, 9},
    {0, MAP_ID_OLDALE_TOWN, 6, 17},
    {0, MAP_ID_DEWFORD_TOWN, 2, 11},
    {0, MAP_ID_LAVARIDGE_TOWN, 9, 7},
    {0, MAP_ID_FALLARBOR_TOWN, 14, 8},
    {0, MAP_ID_VERDANTURF_TOWN, 16, 4},
    {0, MAP_ID_PACIFIDLOG_TOWN, 8, 16},
    {0, MAP_ID_EVER_GRANDE_CITY, 18, 6},
    {26, MAP_ID_BATTLE_TOWER_OUTSIDE, 14, 9},
    {26, MAP_ID_SOUTHERN_ISLAND_EXTERIOR, 15, 20},
};
