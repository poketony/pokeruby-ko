...
# 6 "src/field/slot_machine.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 7 "src/field/slot_machine.c" 2
...
void sub_8104CAC(u8 arg0) {
    ...
    task = &gTasks[((struct UnkStruct2000000 *)(gSharedMem + 0x0))->unk3D];
    task->data[1] = arg0;
...
void sub_8106448(void) {
    ...
    LZDecompressWram(gSlotMachine_Gfx, (void *)(gSharedMem + 0x10000));

    offsetRead = (u32)(void *)(gSharedMem + 0x10000);
    offsetWrite = 0x6000000;
    size = 233 * 32;
    while (1)
    {
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(offsetRead); dmaRegs[1] = (vu32)((void *) (offsetWrite)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x1000)/(16/8))); dmaRegs[2]; };
        offsetRead += 0x1000;
        offsetWrite += 0x1000;
        size -= 0x1000;
        if (size <= 0x1000)
        {
            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(offsetRead); dmaRegs[1] = (vu32)((void *) (offsetWrite)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((size)/(16/8))); dmaRegs[2]; };
            break;
        }
    }
...
void sub_81064B8(void) {
    CpuSet(gUnknown_08E95AB8, (void *)(0x6000000 + (0x800 * (29))), 0x00000000 | ((20 * 32 * 2)/(16/8) & 0x1FFFFF));
...
static void LoadSlotMachineWheelOverlay(void) {
    ...
    screen = (void *)(0x6000000 + (0x800 * (30)));
...
void sub_81065A8(s16 arg0, u16 arg1, u16 arg2, u16 arg3, u16 arg4) {
    u16 *vram = (void *)(0x6000000 + (0x800 * (29)));
...
void sub_81065DC(void) {
    ...
    CpuSet(gUnknown_08E95FB8, (void *)(0x6000000 + (0x800 * (29))), 0x00000000 | ((20 * 32 * 2)/(16/8) & 0x1FFFFF));
