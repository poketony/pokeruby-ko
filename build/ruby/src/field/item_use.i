...
# 19 "src/field/item_use.c" 2
# 1 "include/main.h" 1
# 20 "src/field/item_use.c" 2
...
# 34 "src/field/item_use.c" 2
# 1 "include/string_util.h" 1
# 35 "src/field/item_use.c" 2
...
# 36 "src/field/item_use.c" 2
# 1 "include/task.h" 1
# 37 "src/field/item_use.c" 2
# 1 "include/vars.h" 1
# 38 "src/field/item_use.c" 2
...
void ItemUseOutOfBattle_Bike(u8 taskId)
{
    ...
    if (FlagGet(0x82B) == 1
        || MetatileBehavior_IsVerticalRail(tileBehavior) == 1
        || MetatileBehavior_IsHorizontalRail(tileBehavior) == 1
        || MetatileBehavior_IsIsolatedVerticalRail(tileBehavior) == 1
        || MetatileBehavior_IsIsolatedHorizontalRail(tileBehavior) == 1)
    {
    ...
    for (i = 0; i < events->bgEventCount; i++)
    {
        if ((events -> bgEvents[i].kind == 7) && !FlagGet(events -> bgEvents[i].bgUnion.hiddenItem.hiddenItemId + 600))
        {
            ...
            if ((u16)(newDistanceX + 7) < 15 && (newDistanceY >= -5) && (newDistanceY < 6))
                sub_80C9838(taskId, newDistanceX, newDistanceY);
        }
    }
    sub_80C9720(taskId);
...
{
    if (FieldObjectCheckIfSpecialAnimFinishedOrInactive(&gMapObjects[GetFieldObjectIdByLocalIdAndMap(0xFF, 0, 0)]) == 1)
...
{
    if (IsPlayerFacingUnplantedSoil() == 1)
    {
...
void ItemUseOutOfBattle_TMHM(u8 taskId)
{
    ...
    if (gScriptItemId >= ITEM_HM01)
        DisplayItemMessageOnField(taskId, gOtherText_BootedHM, sub_80C9EE4, 1);
    else
        DisplayItemMessageOnField(taskId, gOtherText_BootedTM, sub_80C9EE4, 1);
}
...
void ItemUseOutOfBattle_Repel(u8 var)
{
    if (VarGet(0x4021) == 0)
    {
        VarSet(0x4021, ItemId_GetHoldEffectParam(gScriptItemId));
...
{
    if (PlayerPartyAndPokemonStorageFull() == 0)
    {
        RemoveBagItem(gScriptItemId, 1);
        sub_80A7094(var);
    }
...
void ItemUseInBattle_StatIncrease(u8 taskId)
{
    ...
    if (ExecuteTableBasedItemEffect_(&gPlayerParty[partyId], gScriptItemId, partyId, 0) != 0)
    {
...
void unref_sub_80CA448(u8 var)
{
    ...
    if (ExecuteTableBasedItemEffect__(0, gScriptItemId, 0) == 0)
    {
        RemoveBagItem(gScriptItemId, 1);
