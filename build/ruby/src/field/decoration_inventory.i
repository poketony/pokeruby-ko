# 1 "src/field/decoration_inventory.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/decoration_inventory.c"
...
# 6 "src/field/decoration_inventory.c" 2
# 1 "include/sprite.h" 1
# 7 "src/field/decoration_inventory.c" 2
# 1 "include/task.h" 1
...
# 8 "src/field/decoration_inventory.c" 2
...
# 9 "src/field/decoration_inventory.c" 2
...
s8 sub_81340A8(u8);
u8 sub_8134194(u8);
# 10 "src/field/decoration_inventory.c" 2



struct DecorationInventory const gDecorationInventories[] = {
    {.items = gSaveBlock1.decorDesk, .size = sizeof gSaveBlock1.decorDesk},
    {.items = gSaveBlock1.decorChair, .size = sizeof gSaveBlock1.decorChair},
    {.items = gSaveBlock1.decorPlant, .size = sizeof gSaveBlock1.decorPlant},
    {.items = gSaveBlock1.decorOrnament, .size = sizeof gSaveBlock1.decorOrnament},
    {.items = gSaveBlock1.decorMat, .size = sizeof gSaveBlock1.decorMat},
    {.items = gSaveBlock1.decorPoster, .size = sizeof gSaveBlock1.decorPoster},
    {.items = gSaveBlock1.decorDoll, .size = sizeof gSaveBlock1.decorDoll},
    {.items = gSaveBlock1.decorCushion, .size = sizeof gSaveBlock1.decorCushion}
};
