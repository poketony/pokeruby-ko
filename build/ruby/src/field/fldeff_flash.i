...
# 12 "src/field/fldeff_flash.c" 2
# 1 "include/sprite.h" 1
# 13 "src/field/fldeff_flash.c" 2
# 1 "include/task.h" 1
# 14 "src/field/fldeff_flash.c" 2
...
{
    if (gMapHeader.cave == 1 && !FlagGet(0x828))
    {
...
void sub_810CE78(u8 taskId)
{
    ...
    (*(vu16 *)(0x4000000 + 0x50)) = 15937;
    (*(vu16 *)(0x4000000 + 0x52)) = 0;
    (*(vu16 *)(0x4000000 + 0x54)) = 0;
    (*(vu16 *)(0x4000000 + 0x8)) = 7948;
    (*(vu16 *)(0x4000000 + 0x0)) = 4416;
