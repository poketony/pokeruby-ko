...
# 2 "src/pokemon/mon_markings.c" 2
# 1 "include/main.h" 1
...
# 3 "src/pokemon/mon_markings.c" 2
...
# 4 "src/pokemon/mon_markings.c" 2
...
# 5 "src/pokemon/mon_markings.c" 2
# 1 "include/songs.h" 1
...
# 6 "src/pokemon/mon_markings.c" 2
# 1 "include/sound.h" 1
...
# 7 "src/pokemon/mon_markings.c" 2
# 1 "include/sprite.h" 1
# 8 "src/pokemon/mon_markings.c" 2
...
{
    sMenu = ptr;
    sMenu->spriteSheetLoadRequired = 0;
}
...
void sub_80F761C(s16 x, s16 y, u16 baseTileTag, u16 basePaletteTag)
{
    ...
    sMenu->spriteSheetLoadRequired = 1;
    ...
    if (spriteId != 64)
    {
        ...
        sMenu->menuTextSprite->oam.shape = 1;
...
void sub_80F7A10(u8 markings, void *dest)
{
    ...
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(src); dmaRegs[1] = (vu32)(dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x80)/(16/8))); dmaRegs[2]; };
}
