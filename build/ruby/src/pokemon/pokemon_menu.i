...
# 2 "src/pokemon/pokemon_menu.c" 2
# 1 "include/pokemon.h" 1
# 3 "src/pokemon/pokemon_menu.c" 2
...
# 4 "src/pokemon/pokemon_menu.c" 2
...
# 5 "src/pokemon/pokemon_menu.c" 2
...
# 6 "src/pokemon/pokemon_menu.c" 2
# 1 "include/menu.h" 1
# 7 "src/pokemon/pokemon_menu.c" 2
...
# 8 "src/pokemon/pokemon_menu.c" 2
...
# 9 "src/pokemon/pokemon_menu.c" 2
# 1 "include/songs.h" 1
...
# 10 "src/pokemon/pokemon_menu.c" 2
# 1 "include/sound.h" 1
...
# 11 "src/pokemon/pokemon_menu.c" 2
# 1 "include/main.h" 1
...
# 12 "src/pokemon/pokemon_menu.c" 2
...
# 13 "src/pokemon/pokemon_menu.c" 2
...
# 14 "src/pokemon/pokemon_menu.c" 2
...
# 15 "src/pokemon/pokemon_menu.c" 2
# 1 "include/moves.h" 1
...
# 16 "src/pokemon/pokemon_menu.c" 2
# 1 "include/data2.h" 1
...
# 17 "src/pokemon/pokemon_menu.c" 2
...
# 18 "src/pokemon/pokemon_menu.c" 2
...
# 19 "src/pokemon/pokemon_menu.c" 2
# 1 "include/item.h" 1
...
# 20 "src/pokemon/pokemon_menu.c" 2
...
# 21 "src/pokemon/pokemon_menu.c" 2
# 1 "include/mail.h" 1
...
# 22 "src/pokemon/pokemon_menu.c" 2
...
# 23 "src/pokemon/pokemon_menu.c" 2
...
# 24 "src/pokemon/pokemon_menu.c" 2
...
# 25 "src/pokemon/pokemon_menu.c" 2
...
# 26 "src/pokemon/pokemon_menu.c" 2
...
# 27 "src/pokemon/pokemon_menu.c" 2
...
# 28 "src/pokemon/pokemon_menu.c" 2
...
u8 sub_8068F18(void);
# 29 "src/pokemon/pokemon_menu.c" 2
...
# 30 "src/pokemon/pokemon_menu.c" 2
...
# 31 "src/pokemon/pokemon_menu.c" 2
...
u8 sub_80A7E5C(s16);
# 32 "src/pokemon/pokemon_menu.c" 2
...
void sub_813B108(u8);
void sub_813B174(u8);
# 33 "src/pokemon/pokemon_menu.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 34 "src/pokemon/pokemon_menu.c" 2
# 42 "src/pokemon/pokemon_menu.c"
...
__attribute__((section("ewram_data"))) static u8 sPokeMenuCursorPos = 0;
__attribute__((section("ewram_data"))) static u8 sPokeMenuOptionsNo = 0;
__attribute__((section("ewram_data"))) static u8 sPokeMenuOptionsOrder[8] = {0};
...
static const u16 sPokeMenuFieldMoves[] =
{
    ...
    MOVE_SOFT_BOILED, MOVE_SWEET_SCENT, 0xFF,
};
...
static void sub_8089A8C(void)
{
    ...
    else
    {
        ...
        {
            for (tableID = 0; sPokeMenuFieldMoves[tableID] != 0xFF; tableID++)
            {
                if (GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 13 + moveID) == sPokeMenuFieldMoves[tableID])
                {
                    u8 fieldID = tableID + 10;
        ...
        if (GetMonData(&gPlayerParty[1], 11) != 0)
            AppendToList(sPokeMenuOptionsOrder, &sPokeMenuOptionsNo, POKEMENU_SWITCH);

        if (ItemIsMail(GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 12)))
...
static void PokemonMenu_Switch(u8 taskID)
{
    ...
    (*(struct Unk2001000 *)(gSharedMem + 0x1000)).unkC = sub_806CD5C;
    (*(struct Unk2001000 *)(gSharedMem + 0x1000)).array[53553] = 1;
    DoPokemonMenu_Switch(taskID);
}

static void sub_808A060(u8 taskID)
{
    if (gMain.newKeys == 0x0040 && sPokeMenuCursorPos != 0)
    {
        sPokeMenuCursorPos = MoveMenuCursor(-1);
        PlaySE(SE_SELECT);
    }
    if (gMain.newKeys == 0x0080 && sPokeMenuCursorPos != 2)
    {
        sPokeMenuCursorPos = MoveMenuCursor(1);
        PlaySE(SE_SELECT);
    }
...
static void sub_808A180(u8 taskID)
{
    if (!gPaletteFade.active)
    {
        u8 mailID = GetMonData(&gPlayerParty[sub_806CA38(taskID)], 64);
        DestroyTask(taskID);
...
static void sub_808A358(void)
{
    while (1)
    {
        if (InitPartyMenu() == 1)
        {
            sub_806C994((*(struct Struct201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId, gLastFieldPokeMenuOpened);
            ChangePartyMenuSelection((*(struct Struct201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId, 0);
            SetMainCallback2(CB2_PartyMenuMain);
            break;
        }
...
static void sub_808A3A4(void)
{
    while (1)
    {
        if (InitPartyMenu() == 1)
        {
            sub_806C994((*(struct Struct201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId, gLastFieldPokeMenuOpened);
            ChangePartyMenuSelection((*(struct Struct201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId, 0);
            (*(struct Struct201B000 *)(gSharedMem + 0x1B000)).unk262 = 3;
            sub_8089E84();
            SetMainCallback2(CB2_PartyMenuMain);
            break;
        }
...
void sub_808A3F8(void)
{
    if (ItemIsMail(gScriptItemId))
    {
        ...
        if (!(bool8)(GetMonData(&gPlayerParty[sub_806CA38(taskID)], 12)))
        {
...
void sub_808A520(void)
{
    ...
    if (gScriptResult == 0)
    {
        ...
        AddBagItem(GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 12), 1);
        TakeMailFromMon(&gPlayerParty[gLastFieldPokeMenuOpened]);
        SetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 12, (void*) &gUnknown_0202E8F8);
...
static void sub_808A8A8(void)
{
    ...
    (*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk262 = 4;
    sub_8089F14();
}
...
static void PokemonMenu_FieldMove(u8 taskID)
{
    ...
    HandleDestroyMenuCursors();
    data[11] = sPokeMenuOptionsOrder[sPokeMenuCursorPos] - 10;
    if (sub_80F9344() == 1)
    {
        MenuZeroFillWindowRect(18, 0, 29, 19);
        if (((data[11] == (POKEMENU_MILK_DRINK - 10) || data[11] == (POKEMENU_SOFT_BOILED - 10))))
            PrintPartyMenuPromptText(9, 0);
        else
            PrintPartyMenuPromptText(sFieldMoveFuncs[data[11]].field_1, 0);
        gTasks[taskID].func = sub_808ABF4;
    }
    else if (data[11] <= 7 && FlagGet(0x807 + data[11]) != 1)
    {
    ...
    {
        if (sFieldMoveFuncs[data[11]].func() == 1)
        {
            sPokeMenuCursorPos = 0;
            if (!((data[11] == (POKEMENU_MILK_DRINK - 10) || data[11] == (POKEMENU_SOFT_BOILED - 10))))
            {
        ...
        {
            MenuZeroFillWindowRect(18, 0, 29, 19);
            if (((data[11] == (POKEMENU_SURF - 10))) && TestPlayerAvatarFlags(8))
...
static void sub_808AAF0(u8 taskID)
{
    if (gUnknown_0202E8F6 != 1 && (gMain.newKeys & 0x0001 || gMain.newKeys & 0x0002))
    {
...
static void sub_808AB34(u8 taskID)
{
    if (!gPaletteFade.active)
    {
        if (!((gTasks[taskID].data[11] == (POKEMENU_FLY - 10))) || ShouldDoBrailleFlyEffect())
...
static void sub_808ABA8(u8 taskID)
{
    if (sub_807D770() == 1)
    {
        gFieldEffectArguments[0] = GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 11);
        gUnknown_03005CE4();
        DestroyTask(taskID);
    }
}
...
{
    return GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 11);
}
...
static bool8 SetUpFieldMove_Waterfall(void)
{
    ...
    if (MetatileBehavior_IsWaterfall(MapGridGetMetatileBehaviorAt(x, y)) == 1
        && IsPlayerSurfingNorth() == 1)
    {
        gFieldCallback = FieldCallback_Teleport;
...
static void sub_808AE8C(void)
{
 ...
 LZDecompressVram(gPartyMenuOrderText2_Gfx, (void *)(0x6000000 + 0x6180));
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        {
            sub_806D668(i);
            if (GetMonData(&gPlayerParty[i], 45) || !CanMonLearnTMHM(&gPlayerParty[i], arg))
                sub_806BC3C(i, 0x9A);
...
static void sub_808AF20(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        if (GetMonData(&gPlayerParty[i], 11))
        {
            if (GetMonData(&gPlayerParty[i], 45) || !GetEvolutionTargetSpecies(&gPlayerParty[i], 3, gScriptItemId))
            {
                sub_806D668(i);
                sub_806BC3C(i, 0);
            }
...
static void sub_808AF80(void)
{
    while (1)
    {
        if (InitPartyMenu() == 1)
        {
            ...
            if (gLastFieldPokeMenuOpened > 5 || !GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 11))
                gLastFieldPokeMenuOpened = 0;
            sub_806C994((*(struct Unk201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId, gLastFieldPokeMenuOpened);
...
static void sub_808B338(u8 taskID)
{
    if (!gPaletteFade.active)
    {
        ...
        gLastFieldPokeMenuOpened = sub_806CA38(taskID);
        mailID = GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 64);
        DestroyTask(taskID);
