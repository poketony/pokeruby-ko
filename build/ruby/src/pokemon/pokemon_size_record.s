...
FormatMonSizeRecord:
	...
	cmp	r4, #0
	bge	.L17	@cond_branch
	ldr	r2, .L18+0x4		@ created by thumb_load_double_from_address
	ldr	r3, .L18+0x8		@ created by thumb_load_double_from_address
	bl	__adddf3
.L17:
	ldr	r2, .L18+0xc		@ created by thumb_load_double_from_address
	ldr	r3, .L18+0x10		@ created by thumb_load_double_from_address
	bl	__divdf3
	bl	__fixunsdfsi
	add	r5, r0, #0
	mov	r1, #0xa
...
.Lfe6:
	...
	.align	2, 0
	.globl	InitShroomishSizeRecord
	.type	 InitShroomishSizeRecord,function
	.thumb_func
...
.L43:
	.word	0x4047
.Lfe7:
	.size	 InitShroomishSizeRecord,.Lfe7-InitShroomishSizeRecord
	.align	2, 0
	.globl	GetShroomishSizeRecordInfo
	.type	 GetShroomishSizeRecordInfo,function
	.thumb_func
...
.L46:
	.word	0x4047
.Lfe8:
	.size	 GetShroomishSizeRecordInfo,.Lfe8-GetShroomishSizeRecordInfo
	.align	2, 0
	.globl	CompareShroomishSize
	.type	 CompareShroomishSize,function
	.thumb_func
...
.L49:
	...
	.word	gScriptResult
.Lfe9:
	.size	 CompareShroomishSize,.Lfe9-CompareShroomishSize
	.align	2, 0
	.globl	InitBarboachSizeRecord
	.type	 InitBarboachSizeRecord,function
	.thumb_func
...
.L52:
	.word	0x404f
.Lfe10:
	.size	 InitBarboachSizeRecord,.Lfe10-InitBarboachSizeRecord
	.align	2, 0
	.globl	GetBarboachSizeRecordInfo
	.type	 GetBarboachSizeRecordInfo,function
	.thumb_func
...
.L55:
	...
	.word	0x143
.Lfe11:
	.size	 GetBarboachSizeRecordInfo,.Lfe11-GetBarboachSizeRecordInfo
	.align	2, 0
	.globl	CompareBarboachSize
	.type	 CompareBarboachSize,function
	.thumb_func
CompareBarboachSize:
	push	{r4, lr}
	ldr	r0, .L58
...
.L58:
	...
	.word	0x143
.Lfe12:
	.size	 CompareBarboachSize,.Lfe12-CompareBarboachSize
	.section .rodata
.LC15:
	.byte	0x48
	.byte	0x49
