# 1 "src/pokemon/pokemon_size_record.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/pokemon/pokemon_size_record.c"
...
# 2 "src/pokemon/pokemon_size_record.c" 2
...
# 3 "src/pokemon/pokemon_size_record.c" 2
# 1 "include/data2.h" 1
...
# 4 "src/pokemon/pokemon_size_record.c" 2
...
# 5 "src/pokemon/pokemon_size_record.c" 2
...
# 6 "src/pokemon/pokemon_size_record.c" 2
...
# 7 "src/pokemon/pokemon_size_record.c" 2
...
# 8 "src/pokemon/pokemon_size_record.c" 2
...
# 9 "src/pokemon/pokemon_size_record.c" 2
# 1 "include/text.h" 1
# 77 "include/text.h"
struct WindowConfig
{
...
# 10 "src/pokemon/pokemon_size_record.c" 2
...
void GiveGiftRibbonToParty(u8 index, u8 ribbonId)
{
    ...
    if (index < 11 && ribbonId < 65)
    {
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            if (GetMonData(pkmn, 11) != 0 && GetMonData(pkmn, 6) == 0)
            {
