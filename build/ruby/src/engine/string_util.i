...
# 493 "src/engine/string_util.c"
static const u8 *ExpandPlaceholder_Version(void) { return gExpandedPlaceholder_Ruby; } static const u8 *ExpandPlaceholder_EvilTeam(void) { return gExpandedPlaceholder_Magma; } static const u8 *ExpandPlaceholder_GoodTeam(void) { return gExpandedPlaceholder_Aqua; } static const u8 *ExpandPlaceholder_EvilLeader(void) { return gExpandedPlaceholder_Maxie; } static const u8 *ExpandPlaceholder_GoodLeader(void) { return gExpandedPlaceholder_Archie; } static const u8 *ExpandPlaceholder_EvilLegendary(void) { return gExpandedPlaceholder_Groudon; } static const u8 *ExpandPlaceholder_GoodLegendary(void) { return gExpandedPlaceholder_Kyogre; }
