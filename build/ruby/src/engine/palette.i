...
# 3 "src/engine/palette.c" 2
# 1 "include/blend_palette.h" 1



void BlendPalette(u16 palOffset, u16 numEntries, u8 coeff, u16 blendColor);
# 4 "src/engine/palette.c" 2
...
__attribute__((section("ewram_data"))) u16 gPlttBufferUnfaded[0x200] = {0};
__attribute__((section("ewram_data"))) u16 gPlttBufferFaded[0x200] = {0};
__attribute__((section("ewram_data"))) static struct PaletteStruct sPaletteStructs[0x10] = {0};
__attribute__((section("ewram_data"))) struct PaletteFadeControl gPaletteFade = {0};
__attribute__((section("ewram_data"))) u32 gFiller_202F394 = 0;
__attribute__((section("ewram_data"))) static u32 sPlttBufferTransferPending = 0;
__attribute__((section("ewram_data"))) static u8 sPaletteDecompressionBuffer[0x400] = {0};
...
void LoadCompressedPalette(const void *src, u16 offset, u16 size)
{
    ...
    CpuSet(sPaletteDecompressionBuffer, gPlttBufferUnfaded + offset, 0x00000000 | ((size)/(16/8) & 0x1FFFFF));
    CpuSet(sPaletteDecompressionBuffer, gPlttBufferFaded + offset, 0x00000000 | ((size)/(16/8) & 0x1FFFFF));
}
...
static void UpdateBlendRegisters(void)
{
    (*(vu16 *)(0x4000000 + 0x50)) = (gPaletteFade.multipurpose1);
    (*(vu16 *)(0x4000000 + 0x54)) = gPaletteFade.y;
    if (gPaletteFade.hardwareFadeFinishing)
    {
        gPaletteFade.hardwareFadeFinishing = 0;
        gPaletteFade.mode = 0;
