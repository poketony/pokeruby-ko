# 1 "src/engine/mystery_event_menu.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/engine/mystery_event_menu.c"
...
# 2 "src/engine/mystery_event_menu.c" 2
# 1 "include/mystery_event_menu.h" 1



void CB2_InitMysteryEventMenu(void);
# 3 "src/engine/mystery_event_menu.c" 2
# 1 "include/link.h" 1
# 32 "include/link.h"
enum
{
...
void SerialCB(void);
# 4 "src/engine/mystery_event_menu.c" 2
# 1 "include/main.h" 1
...
# 5 "src/engine/mystery_event_menu.c" 2
# 1 "include/menu.h" 1
...
# 6 "src/engine/mystery_event_menu.c" 2
...
# 7 "src/engine/mystery_event_menu.c" 2
...
# 8 "src/engine/mystery_event_menu.c" 2
# 1 "include/save.h" 1
...
# 9 "src/engine/mystery_event_menu.c" 2
# 1 "include/songs.h" 1
...
# 10 "src/engine/mystery_event_menu.c" 2
# 1 "include/sound.h" 1
...
# 11 "src/engine/mystery_event_menu.c" 2
# 1 "include/sprite.h" 1
# 12 "src/engine/mystery_event_menu.c" 2
...
# 13 "src/engine/mystery_event_menu.c" 2
...
# 14 "src/engine/mystery_event_menu.c" 2
# 1 "include/task.h" 1
# 15 "src/engine/mystery_event_menu.c" 2
# 1 "include/text.h" 1
# 16 "src/engine/mystery_event_menu.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 17 "src/engine/mystery_event_menu.c" 2

static __attribute__((section("ewram_data"))) u8 gUnknown_02039338 = 0;
...
static void CB2_MysteryEventMenu(void)
{
    ...
    case 4:
        if (MenuUpdateWindowText())
            gMain.state++;
        break;
# 189 "src/engine/mystery_event_menu.c"
    case 5:
    ...
    case 6:
        if (IsLinkConnectionEstablished())
        {
            ...
            if (GetLinkPlayerDataExchangeStatusTimed() == 3)
            {
                ...
                ptr = (u8 *)&gMain;
                offset1 = ((size_t)&((struct Main *)0)->state);
                asm("" ::: "r1");
                ptr += offset1;
                *ptr = 13;
            }
            else if (CheckLanguageMatch())
            {
                ...
                ptr2 = (u8 *)&gMain;
                offset3 = ((size_t)&((struct Main *)0)->state);
                if (dummy)
                    dummy++;
                ptr2 += offset3;
                (*ptr2)++;
            ...
            label:
                ...
                MenuPrintMessageDefaultCoords(gStringVar4);
                ptr = (u8 *)&gMain;
                offset2 = ((size_t)&((struct Main *)0)->state);
                ptr += offset2;
                *ptr = 13;
            }
            break;
    ...
    case 11:
        ...
        { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, gSharedMem, 0x04000000 | 0x01000000 | ((0x7D4)/(32/8) & 0x1FFFFF)); };
