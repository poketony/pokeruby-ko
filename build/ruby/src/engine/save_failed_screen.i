# 1 "src/engine/save_failed_screen.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/engine/save_failed_screen.c"
...
# 2 "src/engine/save_failed_screen.c" 2
...
# 3 "src/engine/save_failed_screen.c" 2
# 1 "include/save_failed_screen.h" 1



void DoSaveFailedScreen(u8);
# 4 "src/engine/save_failed_screen.c" 2
# 1 "include/m4a.h" 1
...
# 5 "src/engine/save_failed_screen.c" 2
# 1 "include/main.h" 1
...
# 6 "src/engine/save_failed_screen.c" 2
# 1 "include/menu.h" 1
...
# 7 "src/engine/save_failed_screen.c" 2
...
# 8 "src/engine/save_failed_screen.c" 2
# 1 "include/save.h" 1
...
# 9 "src/engine/save_failed_screen.c" 2
# 1 "include/sprite.h" 1
# 10 "src/engine/save_failed_screen.c" 2
...
# 11 "src/engine/save_failed_screen.c" 2
...
# 12 "src/engine/save_failed_screen.c" 2
# 1 "include/task.h" 1
# 13 "src/engine/save_failed_screen.c" 2
# 1 "include/text.h" 1
# 14 "src/engine/save_failed_screen.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 15 "src/engine/save_failed_screen.c" 2
# 24 "src/engine/save_failed_screen.c"
static __attribute__((section("ewram_data"))) u16 gSaveFailedType = 0;
static __attribute__((section("ewram_data"))) u16 gSaveFailedClockInfo[9] = {0};
...
static void CB2_SaveFailedScreen(void)
{
    ...
    default:
        ...
        LZ77UnCompVram(&gBirchBagTilemap, (void *)(0x6000000 + 0x3000));
        LZ77UnCompVram(&gBirchGrassTilemap, (void *)(0x6000000 + 0x3800));
        LZ77UnCompVram(&gSaveFailedClockGfx, (void *)(0x6000000 + 0x10020));
        ResetSpriteData();
        ResetTasks();
        ResetPaletteFade();
        ...
        MenuDrawTextWindow(13, (12 - 4), 16, (12 - 4) + 3);
        MenuDrawTextWindow(1, 12, 28, 19);
        MenuPrint(gSystemText_SaveFailedBackupCheck, 2, 12 + 1);
        ...
        (*(vu16 *)(0x4000000 + 0xc)) = (2) | ((0) << 2) | ((6) << 8) | 0x0000 | 0x0000;
        (*(vu16 *)(0x4000000 + 0x8)) = (0) | ((2) << 2) | ((31) << 8) | 0x0000 | 0x0000;
        (*(vu16 *)(0x4000000 + 0x0)) = 0x1000 | 0x0800 | 0x0400 | 0x0100 | 0x0040 | 0x0000;
        gMain.state++;
        break;
    case 1:
...
static void CB2_WipeSave(void)
{
    ...
    while (gDamagedSaveSectors != 0 && wipeTries < 3)
    {
        ...
        {
            MenuDrawTextWindow(1, 12, 28, 19);
            MenuPrint(gSystemText_BackupDamagedGameContinue, 2, 12 + 1);
            SetMainCallback2(CB2_GameplayCannotBeContinued);
            return;
        }

        MenuDrawTextWindow(1, 12, 28, 19);
        MenuPrint(gSystemText_CheckCompleteSaveAttempt, 2, 12 + 1);
    ...
    else
    {
        ...
        if (gGameContinueCallback == 0)
            MenuPrint(gSystemText_SaveCompletedGameEnd, 2, 12 + 1);
        else
            MenuPrint(gSystemText_SaveCompletedPressA, 2, 12 + 1);
    }
...
static void CB2_GameplayCannotBeContinued(void)
{
    ...
    {
        MenuDrawTextWindow(1, 12, 28, 19);
        MenuPrint(gSystemText_GameplayEnded, 2, 12 + 1);
        SetVBlankCallback(VBlankCB);
        SetMainCallback2(CB2_FadeAndReturnToTitleScreen);
    }
}
