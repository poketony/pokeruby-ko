...
# 7 "src/engine/sound.c" 2
# 1 "include/pokemon.h" 1
# 8 "src/engine/sound.c" 2
# 1 "include/songs.h" 1
...
static __attribute__((section("ewram_data"))) struct MusicPlayerInfo *gMPlay_PokemonCry = ((void *)0);
static __attribute__((section("ewram_data"))) u8 gPokemonCryBGMDuckingCounter = 0;
...
bool8 IsBGMPausedOrStopped(void)
{
    if (gMPlay_BGM.status & 0x80000000)
        return 1;
    if (!(gMPlay_BGM.status & 0x0000ffff))
        return 1;
    return 0;
}
...
bool8 IsSEPlaying(void)
{
    if ((gMPlay_SE1.status & 0x80000000) && (gMPlay_SE2.status & 0x80000000))
        return 0;
    if (!(gMPlay_SE1.status & 0x0000ffff) && !(gMPlay_SE2.status & 0x0000ffff))
        return 0;
    return 1;
}
...
bool8 IsSpecialSEPlaying(void)
{
    if (gMPlay_SE3.status & 0x80000000)
        return 0;
    if (!(gMPlay_SE3.status & 0x0000ffff))
        return 0;
    return 1;
}
