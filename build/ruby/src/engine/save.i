...
# 2 "src/engine/save.c" 2
# 1 "include/gba/gba.h" 1
# 3 "src/engine/save.c" 2
...
# 7 "src/engine/save.c" 2
# 1 "include/save_failed_screen.h" 1



void DoSaveFailedScreen(u8);
# 8 "src/engine/save.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 9 "src/engine/save.c" 2
...
static __attribute__((section("ewram_data"))) u32 gLastSaveSectorStatus = 0;

const struct SaveSectionLocation gSaveSectionLocations[] =
{
    {((u8 *) &gSaveBlock2) + (0xF80 * (1 - 1)), ((sizeof(gSaveBlock2) - (0xF80 * (1 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gSaveBlock2) - (0xF80 * (1 - 1))))},
    {((u8 *) &gSaveBlock1) + (0xF80 * (1 - 1)), ((sizeof(gSaveBlock1) - (0xF80 * (1 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gSaveBlock1) - (0xF80 * (1 - 1))))},
    {((u8 *) &gSaveBlock1) + (0xF80 * (2 - 1)), ((sizeof(gSaveBlock1) - (0xF80 * (2 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gSaveBlock1) - (0xF80 * (2 - 1))))},
    {((u8 *) &gSaveBlock1) + (0xF80 * (3 - 1)), ((sizeof(gSaveBlock1) - (0xF80 * (3 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gSaveBlock1) - (0xF80 * (3 - 1))))},
    {((u8 *) &gSaveBlock1) + (0xF80 * (4 - 1)), ((sizeof(gSaveBlock1) - (0xF80 * (4 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gSaveBlock1) - (0xF80 * (4 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (1 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (1 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (1 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (2 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (2 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (2 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (3 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (3 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (3 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (4 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (4 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (4 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (5 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (5 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (5 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (6 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (6 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (6 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (7 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (7 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (7 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (8 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (8 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (8 - 1))))},
    {((u8 *) &gPokemonStorage) + (0xF80 * (9 - 1)), ((sizeof(gPokemonStorage) - (0xF80 * (9 - 1))) >= 0xF80 ? 0xF80 : (sizeof(gPokemonStorage) - (0xF80 * (9 - 1))))}
};

const struct SaveSectionLocation gHallOfFameSaveSectionLocations[] =
{
    {((u8 *) (struct HallOfFame *)(gSharedMem + 0x1E000)) + (0xF80 * (1 - 1)), ((sizeof(struct HallOfFame) - (0xF80 * (1 - 1))) >= 0xF80 ? 0xF80 : (sizeof(struct HallOfFame) - (0xF80 * (1 - 1))))},
    {((u8 *) (struct HallOfFame *)(gSharedMem + 0x1E000)) + (0xF80 * (2 - 1)), ((sizeof(struct HallOfFame) - (0xF80 * (2 - 1))) >= 0xF80 ? 0xF80 : (sizeof(struct HallOfFame) - (0xF80 * (2 - 1))))}
};
...
u8 save_write_to_flash(u16 a1, const struct SaveSectionLocation *location)
{
    ...
    gFastSaveSection = (struct SaveSection *)(gSharedMem + 0x0);
    ...
    else
    {
        ...
        gLastWrittenSector++;
        gLastWrittenSector = gLastWrittenSector % (sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0]));
        gSaveCounter++;
        retVal = 1;

        for (i = 0; i < (sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])); i++)
...
u8 HandleWriteSector(u16 a1, const struct SaveSectionLocation *location)
{
    ...
    sector %= (sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0]));
    sector += (sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])) * (gSaveCounter % 2);
...
{
    u16 i;
    struct SaveSection *section = (struct SaveSection *)(gSharedMem + 0x0);
...
u8 sub_81258BC(u16 a1, const struct SaveSectionLocation *location)
{
    u16 i;
    u16 checksum;
    u16 v3 = (sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])) * (gSaveCounter % 2);
    u16 id;
...
u8 GetSaveValidStatus(const struct SaveSectionLocation *location)
{
    ...
    if (securityPassed)
    {
        if (slotCheckField == ((1 << (sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0]))) - 1))
            saveSlot1Status = 1;
        else
            saveSlot1Status = 255;
    }
    ...
    for (i = 0; i < (sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])); i++)
    {
        DoReadFlashWholeSection(i + (sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])), gFastSaveSection);
        if (gFastSaveSection->security == 0x8012025)
        {
            securityPassed = 1;
            checksum = CalculateChecksum(gFastSaveSection->data, location[gFastSaveSection->id].size);
...
u8 HandleSavingData(u8 saveType)
{
    ...
    switch (saveType)
    {
    case HOF_DELETE_SAVE:
        for (i = ((sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])) * 2 + 0); i < (((sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])) * 2) + ((sizeof(gHallOfFameSaveSectionLocations) / sizeof((gHallOfFameSaveSectionLocations)[0])) * 2)); i++)
            EraseFlashSector(i);
    case HOF_SAVE:
        if (GetGameStat(10) < 999)
            IncrementGameStat(10);
        for (i = 0; i < (sizeof(gHallOfFameSaveSectionLocations) / sizeof((gHallOfFameSaveSectionLocations)[0])); i++)
            HandleWriteSectorNBytes(((sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])) * 2 + 0) + i, gHallOfFameSaveSectionLocations[i].data, gHallOfFameSaveSectionLocations[i].size);
        SaveSerializedGame();
...
bool8 sub_8125DA8(void)
{
    u8 retVal = sub_812550C((sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])), gSaveSectionLocations);
    if (gDamagedSaveSectors)
...
u8 sub_8125DDC(void)
{
    sub_812556C((sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])), gSaveSectionLocations);
    if (gDamagedSaveSectors)
        DoSaveFailedScreen(0);
    return 0;
}
...
u8 sub_8125E04(void)
{
    sub_8125758((sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])), gSaveSectionLocations);
    if (gDamagedSaveSectors)
        DoSaveFailedScreen(0);
    return 0;
}
...
u8 sub_8125EC8(u8 a1)
{
    ...
    default:
        ...
        break;
    case 3:
        result = sub_8125B88(((sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])) * 2 + 0), gHallOfFameSaveSectionLocations[0].data, gHallOfFameSaveSectionLocations[0].size);
        if (result == 1)
            result = sub_8125B88(((sizeof(gSaveSectionLocations) / sizeof((gSaveSectionLocations)[0])) * 2 + 1), gHallOfFameSaveSectionLocations[1].data, gHallOfFameSaveSectionLocations[1].size);
        break;
    }
...
{
    u16 i;
    struct UnkSaveSection *section = (struct UnkSaveSection *)(struct SaveSection *)(gSharedMem + 0x0);
