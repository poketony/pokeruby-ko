# 1 "src/engine/clear_save_data_menu.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/engine/clear_save_data_menu.c"
...
# 2 "src/engine/clear_save_data_menu.c" 2
# 1 "include/clear_save_data_menu.h" 1



void CB2_InitClearSaveDataScreen(void);
# 3 "src/engine/clear_save_data_menu.c" 2
# 1 "include/main.h" 1
...
# 4 "src/engine/clear_save_data_menu.c" 2
# 1 "include/menu.h" 1
...
# 5 "src/engine/clear_save_data_menu.c" 2
...
# 6 "src/engine/clear_save_data_menu.c" 2
# 1 "include/save.h" 1
...
# 7 "src/engine/clear_save_data_menu.c" 2
# 1 "include/songs.h" 1
...
# 8 "src/engine/clear_save_data_menu.c" 2
# 1 "include/sound.h" 1
...
# 9 "src/engine/clear_save_data_menu.c" 2
# 1 "include/sprite.h" 1
# 10 "src/engine/clear_save_data_menu.c" 2
...
# 11 "src/engine/clear_save_data_menu.c" 2
# 1 "include/task.h" 1
# 12 "src/engine/clear_save_data_menu.c" 2
...
static u8 InitClearSaveDataScreen(void)
{
    ...
    default:
        ...
        (*(vu16 *)(0x4000000 + 0x0)) = 0x0000 | 0x0100 | 0x0800;
        gMain.state = 1;
        return 0;
    case 1:
        UpdatePaletteFade();
