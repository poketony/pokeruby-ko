# 1 "src/engine/mystery_event_script.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/engine/mystery_event_script.c"
...
# 2 "src/engine/mystery_event_script.c" 2
# 1 "include/berry.h" 1
...
# 3 "src/engine/mystery_event_script.c" 2
...
# 4 "src/engine/mystery_event_script.c" 2
...
# 5 "src/engine/mystery_event_script.c" 2
...
# 6 "src/engine/mystery_event_script.c" 2
...
# 7 "src/engine/mystery_event_script.c" 2
...
# 8 "src/engine/mystery_event_script.c" 2
...
# 9 "src/engine/mystery_event_script.c" 2
# 1 "include/pokemon.h" 1
# 10 "src/engine/mystery_event_script.c" 2
...
# 11 "src/engine/mystery_event_script.c" 2
...
# 12 "src/engine/mystery_event_script.c" 2
...
# 13 "src/engine/mystery_event_script.c" 2
...
# 14 "src/engine/mystery_event_script.c" 2
...
# 15 "src/engine/mystery_event_script.c" 2
# 1 "include/text.h" 1
# 77 "include/text.h"
struct WindowConfig
{
...
# 16 "src/engine/mystery_event_script.c" 2
# 1 "include/util.h" 1
...
# 17 "src/engine/mystery_event_script.c" 2
# 26 "src/engine/mystery_event_script.c"
...
static __attribute__((section("ewram_data"))) struct ScriptContext sMysteryEventScriptContext = {0};
...
{
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, &gSaveBlock1.recordMixingGift, 0x00000000 | 0x01000000 | ((sizeof(gSaveBlock1.recordMixingGift))/(16/8) & 0x1FFFFF)); };
}
