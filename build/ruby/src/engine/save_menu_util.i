...
# 2 "src/engine/save_menu_util.c" 2
...
# 3 "src/engine/save_menu_util.c" 2
...
# 4 "src/engine/save_menu_util.c" 2
# 1 "include/menu.h" 1
...
# 5 "src/engine/save_menu_util.c" 2
...
# 6 "src/engine/save_menu_util.c" 2
...
# 7 "src/engine/save_menu_util.c" 2
...
# 8 "src/engine/save_menu_util.c" 2
...
# 9 "src/engine/save_menu_util.c" 2
...
void HandleDrawSaveWindowInfo(s16 left, s16 top)
{
    ...
    if (FlagGet(0x801))
    {
        ...
        PrintSaveMapName(++left, ++top);
        PrintSavePlayerName(left, top + 2);
        PrintSaveBadges(left, top + 4);
        PrintSavePokedexCount(left, top + 6);
        PrintSavePlayTime(left, top + 8);
    }
    else
    {
...
u8 GetBadgeCount(void)
{
    ...
    for (badgeFlag = 0x807; badgeFlag <= 0x80E; badgeFlag++)
