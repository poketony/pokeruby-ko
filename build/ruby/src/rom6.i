...
__attribute__((section("ewram_data"))) struct MapPosition gUnknown_0203923C = {0};
...
{
    if (FieldObjectCheckIfSpecialAnimFinishedOrInactive(&gMapObjects[gPlayerAvatar.mapObjectId]) == 1)
    {
        FieldEffectStart(FLDEFF_FIELD_MOVE_SHOW_MON_INIT);
        gTasks[taskId].func = sub_810B428;
    }
...
{
    if (npc_before_player_of_type(0x56) == 1)
    {
