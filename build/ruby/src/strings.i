...
const u8 gDexText_SizeComparedTo[] = _("\h {PLAYER}의 크기 비교");
const u8 gDexText_RegisterComplete[] = _("포켓몬 도감 등록 완료!");
const u8 gDexText_Searching[] = _("검색을 하고있습니다...");
...
const u8 gOtherText_CantBeHeld[] = _("{STR_VAR_1}\f\n지니게 할 수 없습니다!");
const u8 gOtherText_CantBeHeldHere[] = _("여기서는 {STR_VAR_1}\f\n지니게 할 수 없습니다!");
const u8 gOtherText_HowManyToDeposit[] = _("얼마나 맡기겠습니까?");
const u8 gOtherText_DepositedItems[] = _("{STR_VAR_1}\f\n{STR_VAR_2}개 맡겼습니다!");
...
const u8 gOtherText_ThrewAwayItem[] = _("{STR_VAR_1}\f\n{STR_VAR_2}개 버렸습니다");
const u8 gOtherText_OkayToThrowAwayPrompt[] = _("{STR_VAR_1}\f\n{STR_VAR_2}개 버려도\n괜찮습니까?");
...
const u8 gOtherText_ContainsMove[] = _("안에는 {STR_VAR_1}\r\n기록되어 있다!\p{STR_VAR_1}\f\n포켓몬에게 배우게 하겠습니까?");
const u8 gOtherText_UsedItem[] = _("{PLAYER}\s\n{STR_VAR_2}\f 썼다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_RepelLingers[] = _("아직 전에 썼던\n스프레이의 효과가 남아 있습니다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_UsedFlute[] = _("{PLAYER}\s\n{STR_VAR_2}\f 썼다!\p포켓몬과\n마주치기 쉬워졌다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_UsedRepel[] = _("{PLAYER}\s\n{STR_VAR_2}\f 썼다!\p포켓몬과\n마주치기 힘들어졌다!{PAUSE_UNTIL_PRESS}");
...
const u8 ContestStatsText_LiteBluePokeBlock[] = _("하늘색포켓몬스넥");
const u8 ContestStatsText_OlivePokeBlock[] = _("황녹색포켓몬스넥");
...
const u8 gContestStatsText_Sour[] = _("신맛$TASTY$FEEL");

const u8 gContestStatsText_StowCase[] = _("케이스를 닫는다");
const u8 gContestStatsText_ThrowAwayPrompt[] = _("{STR_VAR_1}\f\n전부 버려도 괜찮습니까?");
const u8 gContestStatsText_WasThrownAway[] = _("{STR_VAR_1}\f\n버렸습니다");
const u8 gContestStatsText_NormallyAte[] = _("{STR_VAR_1}\s {STR_VAR_2}\f\n먹었다!{PAUSE_UNTIL_PRESS}");
const u8 gContestStatsText_HappilyAte[] = _("{STR_VAR_1}\s {STR_VAR_2}\f\n기뻐하며 먹었다!{PAUSE_UNTIL_PRESS}");
const u8 gContestStatsText_DisdainfullyAte[] = _("{STR_VAR_1}\s {STR_VAR_2}\f\n싫어하며 먹었다!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_HowManyYouWant[] = _("{STR_VAR_1}\f\n몇 개 구입하시겠습니까?");
...
const u8 gOtherText_SpaceForIsFull[] = _("{STR_VAR_1}\s\n그 이상 지닐 수 없습니다!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_CantBuyThat[] = _("{STR_VAR_2}\s\n파실 수 없습니다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_HowManyToSell[] = _("{STR_VAR_2}\f\n몇 개 파시겠습니까?");
const u8 gOtherText_CanPay[] = _("그 물건은 {STR_VAR_1}원으로\n쳐 드리겠습니다");
const u8 gOtherText_SoldItem[] = _("{STR_VAR_2}\f 건네고\n{STR_VAR_1}원을 받았다");
...
const u8 gOtherText_CantBeSwitched[] = _("{STR_VAR_1}\f\n돌아오게 할 수 없습니다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_AlreadyBattle[] = _("{STR_VAR_1}\s\n이미 배틀에 나가 있습니다{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_AlreadySelected[] = _("{STR_VAR_1}\s 이미\n선택되어 있습니다{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_NoEnergyLeft[] = _("{STR_VAR_1}\s 싸우기 위한\n기력이 남아있지 않습니다!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_WasGivenToHold[] = _("{STR_VAR_1}에게\n{STR_VAR_2}\f 지니게 했다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_AlreadyHolding[] = _("{STR_VAR_1}\s 이미\n{STR_VAR_2}\f 지니고 있습니다\p지니고 있는 도구를\n교환하겠습니까?");
const u8 gOtherText_NotHoldingAnything[] = _("{STR_VAR_1}\s 도구를 아무것도\n지니고 있지 않습니다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_ReceivedTheThingFrom[] = _("{STR_VAR_1}\d로부터\n{STR_VAR_2}\f 가져왔습니다!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_LearnedMove[] = _("{STR_VAR_1}\s 새로\n{STR_VAR_2}\f 배웠다!");
const u8 gOtherText_NotCompatible[] = _("{STR_VAR_1}\h {STR_VAR_2}\s\n상성이 좋지 않았다!\p{STR_VAR_2}\s 배울 수 없다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_WantsToLearn[] = _("{STR_VAR_1}\s 새로\n{STR_VAR_2}\f 배우고 싶다...\p그러나 {STR_VAR_1}\s 기술을 4개\n알고 있어 더 이상 배울 수 없다!\p{STR_VAR_2} 대신\n다른 기술을 잊게 하겠습니까?");
const u8 gOtherText_StopTryingTo[] = _("그럼... {STR_VAR_2}\f\n배우는 것을 포기하겠습니까?");
const u8 gOtherText_DidNotLearnMove2[] = _("{STR_VAR_1}\s {STR_VAR_2}\f\n결국 배우지 않았다!{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_WhichMoveToForget2[] = _("어느 기술을 잊게 하겠습니까?{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_ForgetMove123_2[] = _("{PAUSE 32}1, {PAUSE 15}2, {PAUSE 15}... {PAUSE 15}... {PAUSE 15}{PLAY_SE SE_KON}짠!\p{STR_VAR_1}\s {STR_VAR_2}\f\n깨끗이 잊었다!\p그리고...!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_WokeUp[] = _("{STR_VAR_1}\s\n눈을 떴다!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_BecameHealthy[] = _("{STR_VAR_1}\s\n건강해졌다!{PAUSE_UNTIL_PRESS}");
...
const u8 OtherText_GiveWhat[] = _("Boost PP of which move?");
const u8 OtherText_DoWhat[] = _("{STR_VAR_1}\f 어떻게 할까?");
...
const u8 OtherText_ChoosePoke2[] = _("포켓몬을 선택해 주십시오");
...
const u8 SecretBaseText_PutOutDecor[] = _("선택한 굿즈를 꺼냅니다");
const u8 SecretBaseText_StoreChosenDecor[] = _("선택한 굿즈를 PC에 맡깁니다");
const u8 SecretBaseText_ThrowAwayDecor[] = _("필요없는 굿즈를 버립니다");
const u8 gSecretBaseText_NoDecors[] = _("PC에 굿즈가 없습니다{PAUSE_UNTIL_PRESS}");
...
const u8 gSecretBaseText_GoldRank[] = _("골드");
const u8 gSecretBaseText_SilverRank[] = _("실버");
...
const u8 gSecretBaseText_NoDecor[] = _("PC에 굿즈가 없습니다");
...
const u8 gSecretBaseText_NoDecorInUse[] = _("방 안에 놓여진 굿즈가 없습니다!{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_NoItems[] = _("PC에 도구가 없습니다{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_NoMoreRoom[] = _("There is no more\nroom in the BAG.");
const u8 gOtherText_HowManyToWithdraw[] = _("몇 개 꺼내겠습니까?");
const u8 gOtherText_WithdrewThing[] = _("{STR_VAR_1}\f\n{STR_VAR_2}개 꺼냈습니다");
...
const u8 OtherText_Info2[] = _("설명을 듣는다");
...
const u8 PCText_IsSelected[] = _("\f 어떻게 하겠습니까?");
...
const u8 PCText_WasReleased[] = _("\f 밖에 놓아주었다");
...
const u8 PCText_CameBack[] = _("\r 되돌아와 버렸다!");
...
const u8 gOtherText_TrainersPokemon[] = _("{PALETTE 5}가지고 있는 포켓몬");
...
const u8 gOtherText_AtBattleStart[] = _("배틀이 시작되었을 때");
...
const u8 gOtherText_WasEnhanced[] = _("\r 올랐다!");
