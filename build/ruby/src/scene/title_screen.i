...
# 10 "src/scene/title_screen.c" 2
# 1 "include/main_menu.h" 1



void CB2_InitMainMenu(void);
# 11 "src/scene/title_screen.c" 2
...
# 12 "src/scene/title_screen.c" 2
# 1 "include/reset_rtc_screen.h" 1



void CB2_InitResetRtcScreen(void);
# 13 "src/scene/title_screen.c" 2
# 1 "include/sound.h" 1
...
# 14 "src/scene/title_screen.c" 2
# 1 "include/sprite.h" 1
# 15 "src/scene/title_screen.c" 2
# 1 "include/task.h" 1
...
# 17 "src/scene/title_screen.c" 2
# 25 "src/scene/title_screen.c"
...
static __attribute__((section("ewram_data"))) u8 gUnknown_0202F7E4 = 0;
static __attribute__((section("ewram_data"))) f32 gLogoX = 0;
static __attribute__((section("ewram_data"))) f32 gLogoY = 0;
# 50 "src/scene/title_screen.c"
...
void SpriteCallback_VersionBannerLeft(struct Sprite *sprite)
{
  ...
  sprite->pos1.x = 164;
    ...
    else
    {
        ...
        {
            sprite->invisible = 0;
            if (sprite->pos1.x != 164)
                sprite->pos1.x += 2;
            sprite->pos1.y = 50;
            (*(vu16 *)(0x4000000 + 0x52)) = gUnknown_08393E64[task->data[5] / 2];
        }
    }
}
...
void SpriteCallback_PokemonLogoShine(struct Sprite *sprite)
{
    if (gTasks[gUnknown_0202F7E4].data[1] == 0 && sprite->pos1.x < 272)
    {
        if (sprite->data[0])
        {
            ...
            backgroundColor = ((((sprite->data[1]) & 31) << 10) + (((sprite->data[1]) & 31) << 5) + ((sprite->data[1]) & 31));
            gPlttBufferFaded[0] = backgroundColor;
            gPlttBufferFaded[21] = backgroundColor;
        }
        sprite->pos1.x += 4;
    }
    else
    {
        ...
        gPlttBufferFaded[21] = ((0) | ((0) << 5) | ((0) << 10));
...
void CB2_InitTitleScreen(void)
{
    ...
    case 0:
        ...
        *((u16 *)0x5000000) = ((31) | ((31) << 5) | ((31) << 10));
        ...
        { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)(0x5000000 + 2)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((0x3FE)/(16/8))); dmaRegs[2]; }; };
        ResetPaletteFade();
        gMain.state = 1;
        break;
    case 1:
        LZ77UnCompVram(gUnknown_08E9D8CC, (void *)0x6000000);
        LZ77UnCompVram(gUnknown_08E9F7E4, (void *)(0x6000000 + 0x4800));
        LoadPalette(gUnknown_08E9F624, 0, 0x1C0);
        LZ77UnCompVram(sLegendaryMonPixelData, (void *)(0x6000000 + 0x8000));
        LZ77UnCompVram(sLegendaryMonTilemap, (void *)(0x6000000 + 0xC000));
        LZ77UnCompVram(sBackdropTilemap, (void *)(0x6000000 + 0xC800));
    ...
    case 4:
    {
        ...
        (*(vu32 *)(0x4000000 + 0x28)) = gLogoX * 256;
        (*(vu32 *)(0x4000000 + 0x2c)) = gLogoY * 256;
        (*(vu16 *)(0x4000000 + 0x40)) = 0;
        (*(vu16 *)(0x4000000 + 0x44)) = 0;
        (*(vu16 *)(0x4000000 + 0x42)) = 0;
        (*(vu16 *)(0x4000000 + 0x46)) = 0;
        (*(vu16 *)(0x4000000 + 0x48)) = 0x1F1F;
        (*(vu16 *)(0x4000000 + 0x4a)) = 0x3F1F;
        (*(vu16 *)(0x4000000 + 0x50)) = 0x84;
        (*(vu16 *)(0x4000000 + 0x52)) = 0;
        (*(vu16 *)(0x4000000 + 0x54)) = 0x8;
        (*(vu16 *)(0x4000000 + 0x8)) = (3) | ((2) << 2) | ((24) << 8) | 0x0000 | 0x0000;
        (*(vu16 *)(0x4000000 + 0xa)) = (2) | ((2) << 2) | ((25) << 8) | 0x0000 | 0x0000;
        (*(vu16 *)(0x4000000 + 0xc)) = (1) | ((0) << 2) | ((9) << 8) | 0x0080 | 0x4000;
...
static void Task_TitleScreenPhase1(u8 taskId)
{
    ...
    else
    {
        ...
        (*(vu16 *)(0x4000000 + 0x50)) = 0x3F50;
        (*(vu16 *)(0x4000000 + 0x52)) = 0x1F;
        (*(vu16 *)(0x4000000 + 0x54)) = 0;


        spriteId = CreateSprite(&sVersionBannerLeftSpriteTemplate, 64, 50, 0);
        gSprites[spriteId].invisible = 1;
        gSprites[spriteId].data[1] = taskId;


        spriteId = CreateSprite(&sVersionBannerRightSpriteTemplate, 128, 50, 0);
        gSprites[spriteId].invisible = 1;
        gSprites[spriteId].data[1] = taskId;
...
static void Task_TitleScreenPhase2(u8 taskId)
{
    ...
    if (gTasks[taskId].data[0] != 0)
 {
  ...
  if (!(gTasks[taskId].data[0] & 1) && gLogoX < 0)
   gLogoX += 0.875;
  else if (gLogoX >= 0)
   gLogoX = 0;
  if (!(gTasks[taskId].data[0] & 1) && gLogoY < -4)
   gLogoY += 0.875;
  else if (gLogoY >= -4)
   gLogoY = -4;
    ...
    } else
    {
        ...
        (*(vu16 *)(0x4000000 + 0x0)) = 0x0001
                    ...
                    | 0x0400
                    | 0x1000;
        CreatePressStartBanner(240 / 2, 108);
        CreateCopyrightBanner(240 / 2, 148);
...
{
    (*(vu16 *)(0x4000000 + 0x50)) = 0x2142;
    (*(vu16 *)(0x4000000 + 0x52)) = 0x1F0F;
    (*(vu16 *)(0x4000000 + 0x54)) = 0;
    ...
    else
    {
        ...
        if ((gMain.heldKeys & (0x0002 | 0x0004 | 0x0020)) == (0x0002 | 0x0004 | 0x0020)
          && CanResetRTC() == 1)
        {
            FadeOutBGM(4);
        ...
        {
            (*(vu32 *)(0x4000000 + 0x28)) = 0 * 256;
            (*(vu32 *)(0x4000000 + 0x2c)) = -4 * 256;
            gTasks[taskId].data[0]++;
...
static void UpdateLegendaryMarkingColor(u8 frameNum)
{
    ...
    if ((frameNum % 4) == 0)
    {
        u8 colorIntensity = (frameNum >> 2) & 31;
        u8 fadeDarker = (frameNum >> 2) & 32;

        if (!fadeDarker)
            palette = ((0) | ((0) << 5) | (((colorIntensity)) << 10));
        else
            palette = ((0) | ((0) << 5) | (((31 - colorIntensity)) << 10));
