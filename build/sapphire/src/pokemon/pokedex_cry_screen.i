# 1 "src/pokemon/pokedex_cry_screen.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/pokemon/pokedex_cry_screen.c"
...
# 2 "src/pokemon/pokedex_cry_screen.c" 2
...
# 3 "src/pokemon/pokedex_cry_screen.c" 2
...
# 4 "src/pokemon/pokedex_cry_screen.c" 2
# 1 "include/sprite.h" 1
# 5 "src/pokemon/pokedex_cry_screen.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 6 "src/pokemon/pokedex_cry_screen.c" 2
...
u8 ShowPokedexCryScreen(struct CryRelatedStruct *cry, u8 arg1) {
    ...
    {
    case 0:
        LZ77UnCompVram(gUnknown_083FAF3C, (void *) (0x6000000 + cry->unk0));
    ...
    case 1:
    {
        ...
        vram = (void *)(0x6000000 + (0x800 * (cry->unk2)));
        ...
        for (row = 0; row < 8; row++)
        {
            for (col = 0; col < 10; col++)
            {
                y = row + cry->yPos;
                x = col + cry->xPos;
                *(u16 *) (vram + (y * 64 + x * 2)) = (gUnknown_083FAE7C[row * 10 + col] | (cry->paletteNo << 12)) + r12;
            }
        }
    ...
    case 2:
    {
        ...
        (*(struct Unk201C800 *)(gSharedMem + 0x1C800)).unk_4 = CreateSprite(&gSpriteTemplate_83FB774, 40 + cry->xPos * 8, 56 + cry->yPos * 8, 1);
        (*(struct Unk201C800 *)(gSharedMem + 0x1C800)).unk_0 = 0x20;
        (*(struct Unk201C800 *)(gSharedMem + 0x1C800)).unk_1 = 0x20;
        (*(struct Unk201C800 *)(gSharedMem + 0x1C800)).unk_2 = 0;
