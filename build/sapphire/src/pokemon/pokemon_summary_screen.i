# 1 "src/pokemon/pokemon_summary_screen.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/pokemon/pokemon_summary_screen.c"
...
# 2 "src/pokemon/pokemon_summary_screen.c" 2
...
# 3 "src/pokemon/pokemon_summary_screen.c" 2
# 1 "include/link.h" 1
# 32 "include/link.h"
enum
{
...
void SerialCB(void);
# 4 "src/pokemon/pokemon_summary_screen.c" 2
# 1 "include/menu.h" 1
...
# 5 "src/pokemon/pokemon_summary_screen.c" 2
# 1 "include/pokemon.h" 1
# 6 "src/pokemon/pokemon_summary_screen.c" 2
...
# 7 "src/pokemon/pokemon_summary_screen.c" 2
...
# 8 "src/pokemon/pokemon_summary_screen.c" 2
...
# 9 "src/pokemon/pokemon_summary_screen.c" 2
# 1 "include/tv.h" 1
...
# 10 "src/pokemon/pokemon_summary_screen.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 11 "src/pokemon/pokemon_summary_screen.c" 2

bool8 PokemonSummaryScreen_CheckOT(struct Pokemon *mon)
{
    u32 trainerId;

    if (*(struct Pokemon **)(gSharedMem + 0x18000) == gEnemyParty)
    {
...
void PokemonSummaryScreen_PrintTrainerMemo(struct Pokemon *pokemon, u8 left, u8 top)
{
    ...
    if (PokemonSummaryScreen_CheckOT(pokemon) == 1)
    {
        locationMet = GetMonData(pokemon, 35);

        if (GetMonData(pokemon, 36) == 0)
        {
        ...
        {
            u8 levelMet = GetMonData(pokemon, 36);
