# 1 "src/pokemon/pokemon_storage_system.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/pokemon/pokemon_storage_system.c"
...
# 2 "src/pokemon/pokemon_storage_system.c" 2
...
# 3 "src/pokemon/pokemon_storage_system.c" 2
# 1 "include/menu.h" 1
...
# 4 "src/pokemon/pokemon_storage_system.c" 2
...
# 5 "src/pokemon/pokemon_storage_system.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 6 "src/pokemon/pokemon_storage_system.c" 2
...
void sub_8098898(u8 index) {
    ...
    MenuDrawTextWindow(7, 16, 29, 19);

    switch (gUnknown_083B6DF4[index].format)
    {

    case 2:
        ptr = StringCopy((u8 *)(&gSharedMem[0x2694]), gUnknown_083B6DF4[index].text);
        ptr = StringCopy(ptr, (u8 *)(&gSharedMem[0x11FA]));
        break;

    case 5:
        ptr = StringCopy((u8 *)(&gSharedMem[0x2694]), gUnknown_083B6DF4[index].text);
        ptr = StringCopy(ptr, (u8 *)(&gSharedMem[0x26E4]));
        break;

    case 1:

        ptr = StringCopy((u8 *)(&gSharedMem[0x2694]), (u8 *)(&gSharedMem[0x11FA]));
        ptr = StringCopy(ptr, gUnknown_083B6DF4[index].text);
        break;

    case 4:

        ptr = StringCopy((u8 *)(&gSharedMem[0x2694]), (u8 *)(&gSharedMem[0x26E4]));
        ptr = StringCopy(ptr, gUnknown_083B6DF4[index].text);
        break;
...

    {
        ...
        ptr = StringCopy((u8 *)(&gSharedMem[0x2694]), gUnknown_083B6DF4[index].text);
        ptr = StringCopy(ptr - 1, (u8 *)(&gSharedMem[0x26E4]));
        ptr = StringCopy(ptr, stringLength);
    }
        break;
    ...
    while (ptr < (u8 *)(&gSharedMem[0x26A6]))
    {
            ptr[0] = 0x00;
            ptr++;
    }
    ...
    ptr[0] = 0xFF;
    MenuPrint((u8 *)(&gSharedMem[0x2694]), 8, 17);
}
