...
void unref_sub_8124F94(struct UnknownStruct1 *a)
{
    ...
    a->paletteNum = 0;
    a->unk2 = 0;
    a->dest = (void *)0x6000000;
    { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(a->unk8); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(a->unk8))/(16/8))); dmaRegs[2]; }; };
    { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(a->unk88); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(a->unk88))/(16/8))); dmaRegs[2]; }; };
}
...
u8 unref_sub_8124FD8(struct UnknownStruct1 *a, const struct UnknownStruct2 *b)
{
    while (1)
    {
        ...
        if (b->unk8 == 0)
        {
            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(b->src); dmaRegs[1] = (vu32)(a->dest + a->unk2 * 64); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((r6 * 32)/(16/8))); dmaRegs[2]; };
        }
        else
        {
...
u8 unref_sub_81250A4(struct UnknownStruct1 *a, struct UnknownStruct3 *b)
{
    while (1)
    {
        ...
        if (a->paletteNum < 16 && b->paletteSrc == ((void *)0))
            return 0;
        if (a->paletteNum >= 16)
            break;
