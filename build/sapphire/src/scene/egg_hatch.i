...
# 6 "src/scene/egg_hatch.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 7 "src/scene/egg_hatch.c" 2
# 1 "include/items.h" 1
...
# 13 "src/scene/egg_hatch.c" 2
# 1 "include/pokemon.h" 1
# 14 "src/scene/egg_hatch.c" 2
# 1 "include/rng.h" 1
...
# 20 "src/scene/egg_hatch.c" 2
# 1 "include/task.h" 1
# 21 "src/scene/egg_hatch.c" 2
# 1 "include/text.h" 1
# 22 "src/scene/egg_hatch.c" 2
...
static void CreatedHatchedMon(struct Pokemon *egg, struct Pokemon *temp)
{
    ...
    for (i = 0; i < 4; i++)
    {
        SetMonData(temp, 13 + i, (const u8 *) &moves[i]);
    }

    for (i = 0; i < 6; i++)
    {
        SetMonData(temp, 39 + i, (const u8 *) &ivs[i]);
    }
    ...
    SetMonData(temp, 34, (const u8 *) &pokerus);
...
static void AddHatchedMonToParty(u8 id)
{
    ...
    ball = ITEM_POKE_BALL;
    SetMonData(mon, 38, (const u8*) &ball);

    caughtLvl = 0;
    SetMonData(mon, 36, (const u8*) &caughtLvl);
    ...
    case 0:
        {
            ...
            HandleLoadSpecialPokePic(&gMonFrontPicTable[species], gMonFrontPicCoords[species].coords, gMonFrontPicCoords[species].y_offset, (u32)(&gSharedMem[0]), gUnknown_081FAF4C[2 * a0 + 1], species, pid);
...
static void CB2_EggHatch_0(void)
{
    ...
    case 0:
        ...
        gEggHatchData = (struct EggHatchData*)(&gSharedMem[0x18000]);
    ...
    case 2:
        ...
        CpuSet(&gUnknown_08D00524, (&gSharedMem[0]), 0x800);
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)((&gSharedMem[0])); dmaRegs[1] = (vu32)((void*)(0x6000000 + 0x2800)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x500)/(16/8))); dmaRegs[2]; };
    ...
    case 7:
        {
            ...
            offsetWrite2 = (u32)(0x6000000 + 0x6000);
            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(offsetRead2); dmaRegs[1] = (vu32)((void*)(offsetWrite2)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x1000)/(16/8))); dmaRegs[2]; };
            gMain.state++;
        }
        break;
    case 8:
        (*(vu16 *)(0x4000000 + 0xa)) = 0x501;
    ...
    case 9:
        {
            ...
            if ((menuInput = ProcessMenuInputNoWrap_()) != -2)
            {
                if (menuInput != -1 && menuInput != 1)
                {
                    ...
                    species = GetMonData(&gPlayerParty[gEggHatchData->eggPartyID], 11);
                    gender = GetMonGender(&gPlayerParty[gEggHatchData->eggPartyID]);
                    personality = GetMonData(&gPlayerParty[gEggHatchData->eggPartyID], 0, 0);
