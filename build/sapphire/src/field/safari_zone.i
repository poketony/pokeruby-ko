...
__attribute__((section("ewram_data"))) static u16 gSafariZoneStepCounter = 0;
__attribute__((section("ewram_data"))) static struct PokeblockFeeder gPokeblockFeeders[10] = {0};
