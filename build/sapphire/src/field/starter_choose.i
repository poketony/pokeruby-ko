...
# 2 "src/field/starter_choose.c" 2
...
# 3 "src/field/starter_choose.c" 2
# 1 "include/data2.h" 1
...
# 4 "src/field/starter_choose.c" 2
...
# 5 "src/field/starter_choose.c" 2
# 1 "include/main.h" 1
...
# 6 "src/field/starter_choose.c" 2
# 1 "include/menu.h" 1
...
# 7 "src/field/starter_choose.c" 2
...
# 8 "src/field/starter_choose.c" 2
...
# 9 "src/field/starter_choose.c" 2
# 1 "include/songs.h" 1
...
# 10 "src/field/starter_choose.c" 2
# 1 "include/sound.h" 1
...
# 11 "src/field/starter_choose.c" 2
...
# 12 "src/field/starter_choose.c" 2
# 1 "include/sprite.h" 1
# 13 "src/field/starter_choose.c" 2
...
# 14 "src/field/starter_choose.c" 2
...
# 15 "src/field/starter_choose.c" 2
# 1 "include/task.h" 1
# 16 "src/field/starter_choose.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 17 "src/field/starter_choose.c" 2
...
# 18 "src/field/starter_choose.c" 2
...
void CB2_ChooseStarter(void)
{
    ...
    (*(vu16 *)(0x4000000 + 0x48)) = 0x3F;
    (*(vu16 *)(0x4000000 + 0x4a)) = 0x1F;
    (*(vu16 *)(0x4000000 + 0x40)) = 0;
    (*(vu16 *)(0x4000000 + 0x44)) = 0;
    (*(vu16 *)(0x4000000 + 0x50)) = 0xFE;
    (*(vu16 *)(0x4000000 + 0x52)) = 0;
    (*(vu16 *)(0x4000000 + 0x54)) = 0x7;
...
static void Task_StarterChoose1(u8 taskId)
{
    CreateStarterPokemonLabel(0xFF, gTasks[taskId].data[0]);
...
static void Task_StarterChoose2(u8 taskId)
{
    ...
    if (gMain.newKeys & 0x0001)
    {
        ...
        spriteId = CreatePokemonFrontSprite(
          GetStarterPokemon(gTasks[taskId].data[0]),
          gStarterChoose_PokeballCoords[selection][0],
          gStarterChoose_PokeballCoords[selection][1]);
    ...
    {
        if ((gMain.newKeys & 0x0020) && selection > 0)
        {
            gTasks[taskId].data[0]--;
            CreateStarterPokemonLabel(selection, gTasks[taskId].data[0]);
        }
        else if ((gMain.newKeys & 0x0010) && selection < 2)
        {
            gTasks[taskId].data[0]++;
            CreateStarterPokemonLabel(selection, gTasks[taskId].data[0]);
        }
...
# 484 "src/field/starter_choose.c"
static void CreateStarterPokemonLabel(u8 prevSelection, u8 selection)
{
    ...
    dstIndex = 5;
    { u8 *p = labelText + 5; *p = 0xFC; };
    { u8 *p = labelText + 6; *p = 0x11; };
    { u8 *p = labelText + 7; *p = dstIndex; };


    dstIndex = 8;
    srcIndex = 0;
    while (category[srcIndex] != 0xFF && srcIndex <= 10)
    {
    ...
    (*(vu16 *)(0x4000000 + 0x40)) = (((labelLeft) << 8) | (labelRight));
    (*(vu16 *)(0x4000000 + 0x44)) = (((labelTop) << 8) | (labelBottom));
}
...
static void sub_810A62C(struct Sprite *sprite)
{
    sprite->pos1.x = gUnknown_083F76E4[gTasks[sprite->data[0]].data[0]][0];
    sprite->pos1.y = gUnknown_083F76E4[gTasks[sprite->data[0]].data[0]][1];
