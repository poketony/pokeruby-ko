...
# 10 "src/field/use_pokeblock.c" 2
...
# 11 "src/field/use_pokeblock.c" 2
# 1 "include/sprite.h" 1
# 12 "src/field/use_pokeblock.c" 2
# 1 "include/pokemon.h" 1
# 13 "src/field/use_pokeblock.c" 2
...
# 14 "src/field/use_pokeblock.c" 2
...
# 15 "src/field/use_pokeblock.c" 2
# 1 "include/text.h" 1
# 77 "include/text.h"
struct WindowConfig
{
...
# 16 "src/field/use_pokeblock.c" 2
# 1 "include/menu.h" 1
...
# 17 "src/field/use_pokeblock.c" 2
# 1 "include/sound.h" 1
...
# 18 "src/field/use_pokeblock.c" 2
# 1 "include/songs.h" 1
...
# 19 "src/field/use_pokeblock.c" 2
...
# 20 "src/field/use_pokeblock.c" 2
...
static __attribute__((section("ewram_data"))) struct UnkPokenavStruct_Sub1 *gUnknown_02039304 = ((void *)0);
static __attribute__((section("ewram_data"))) MainCallback gUnknown_02039308 = ((void *)0);
static __attribute__((section("ewram_data"))) struct Pokeblock *gUnknown_0203930C = ((void *)0);
...
static void sub_8136294(void)
{
    ...
    switch (gUnknown_02039304->unk50)
    {
        case 0:
            ...
            if ((bool8)c1LinkRelatedActive == 0)
            {
        ...
        case 6:
            ...
            gUnknown_083DFEC4->unk87E0 = ((void *)0);
        ...
        case 11:
            ...
            gUnknown_083DFEC4->unk8768 = ((void *)0);
            sub_80F4BD0();
        ...
        case 12:
            if (!sub_80F1778())
            {
                (*(vu16 *)(0x4000000 + 0x1a)) = 6;
                (*(vu16 *)(0x4000000 + 0x1e)) = 6;
                gUnknown_02039304->unk50++;
            }
            break;
        case 13:
        ...
        case 15:
            ...
            break;
        case 16:
            { vu32 *_dest = (vu32 *)((void *)(0x6000000 + (0x800 * (31)))); u32 _size = 0x800; { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((_size)/(32/8))); dmaRegs[2]; }; }; };
            (*(vu16 *)(0x4000000 + 0x16)) = 0;
            (*(vu16 *)(0x4000000 + 0x14)) = 0;
            (*(vu16 *)(0x4000000 + 0xa)) = ((31) << 8);
            gUnknown_02039304->unk50++;
            break;
        case 17:
        ...
        case 21:
            ...
            (*(vu16 *)(0x4000000 + 0x42)) = 0x9b;
            (*(vu16 *)(0x4000000 + 0x44)) = 0x3273;
            (*(vu16 *)(0x4000000 + 0x46)) = 0x3273;
            (*(vu16 *)(0x4000000 + 0x48)) = 0x3f3f;
            (*(vu16 *)(0x4000000 + 0x4a)) = 0x1b;
            (*(vu16 *)(0x4000000 + 0x12)) = 0x28;
            (*(vu16 *)(0x4000000 + 0x0)) = 0x0040 | 0x0F00 | 0x1000 | 0x2000 | 0x4000;
...
static void sub_81369CC(void)
{
    switch (gUnknown_02039304->unk50)
    {
        ...
        case 4:
            ...
            break;
        case 5:
            if (gMain.newKeys & (0x0001 | 0x0002) && !sub_8136D00())
            {
...
static void sub_8136BB8(void)
{
    GetMonData(&gPlayerParty[sub_81370A4(gUnknown_083DFEC4->unk87DC)], 2, gUnknown_02039304->stringBuffer);
...
static void sub_8136E40(struct Pokeblock *pokeblock, struct Pokemon *pokemon)
{
    ...
    if (GetMonData(pokemon, 48) != 255)
    {
        ...
        cstat = (u8)GetMonData(pokemon, 48);
        cstat = cstat + pokeblock->feel;
        if (cstat > 255)
            cstat = 255;
        data = cstat;
        SetMonData(pokemon, 48, &data);
    }
}
