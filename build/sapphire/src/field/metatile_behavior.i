# 1 "src/field/metatile_behavior.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/metatile_behavior.c"
...
# 2 "src/field/metatile_behavior.c" 2
...
# 3 "src/field/metatile_behavior.c" 2
# 1 "include/metatile_behaviors.h" 1
# 4 "src/field/metatile_behavior.c" 2
...
{
    if (MetatileBehavior_IsSurfableWaterOrUnderwater(var) == 0 && MetatileBehavior_IsEncounterTile(var) == 1)
        return 1;
    else
        return 0;
}
...
{
    if (MetatileBehavior_IsSurfableWaterOrUnderwater(var) == 1 && MetatileBehavior_IsEncounterTile(var) == 1)
        return 1;
    else
        return 0;
}
...
{
    if (MetatileBehavior_IsSurfableWaterOrUnderwater(var) && MetatileBehavior_IsWaterfall(var) == 0)
        return 1;
    else
        return 0;
}
...
{
    if (var == 0x10 || var == 0x15 || var == 0x11 || var == 0x12 || var == 0x14 || (var >= 0x50 && var <= 0x53))
        return 1;
    else
        return 0;
}
...
{
    if (var == 0x0A || var == 0x03 || var == 0x28 || MetatileBehavior_IsPacifidlogLog(var) != 0)
        return 1;
    else
        return 0;
}
...
{
    if (var == 0x02 || var == 0x03 || var == 0x24 || var == 0x09)
        return 1;
    else
        return 0;
}
