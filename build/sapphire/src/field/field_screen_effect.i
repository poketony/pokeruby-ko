# 1 "src/field/field_screen_effect.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/field_screen_effect.c"
...
# 2 "src/field/field_screen_effect.c" 2
...
# 3 "src/field/field_screen_effect.c" 2
...
# 4 "src/field/field_screen_effect.c" 2
# 1 "include/menu.h" 1
...
# 5 "src/field/field_screen_effect.c" 2
...
# 6 "src/field/field_screen_effect.c" 2
...
# 7 "src/field/field_screen_effect.c" 2
...
# 8 "src/field/field_screen_effect.c" 2
# 1 "include/task.h" 1
# 9 "src/field/field_screen_effect.c" 2
# 1 "include/text.h" 1
# 10 "src/field/field_screen_effect.c" 2
...
# 11 "src/field/field_screen_effect.c" 2
...
static void sub_80816A8(u8 taskId)
{
    ...
    case 0:
        ...
        (*(vu16 *)(0x4000000 + 0x0)) &= 0xBFFF;
        (*(vu16 *)(0x4000000 + 0x50)) |= gUnknown_081E29E8[0];
        (*(vu16 *)(0x4000000 + 0x52)) = 1804;
        (*(vu16 *)(0x4000000 + 0x48)) = 63;
        (*(vu16 *)(0x4000000 + 0x4a)) = 30;
    ...
    case 5:
        ...
        (*(vu16 *)(0x4000000 + 0x0)) = data[6];
        (*(vu16 *)(0x4000000 + 0x50)) = data[7];
        (*(vu16 *)(0x4000000 + 0x52)) = data[8];
        (*(vu16 *)(0x4000000 + 0x48)) = data[9];
        (*(vu16 *)(0x4000000 + 0x4a)) = data[10];
        EnableBothScriptContexts();
        DestroyTask(taskId);
        break;
    }
