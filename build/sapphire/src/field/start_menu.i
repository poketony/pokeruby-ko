...
# 13 "src/field/start_menu.c" 2
# 1 "include/option_menu.h" 1



void CB2_InitOptionMenu(void);
# 14 "src/field/start_menu.c" 2
...
# 25 "src/field/start_menu.c" 2
# 1 "include/sprite.h" 1
# 26 "src/field/start_menu.c" 2
# 1 "include/string_util.h" 1
# 27 "src/field/start_menu.c" 2
...
# 29 "src/field/start_menu.c" 2
# 1 "include/task.h" 1
# 30 "src/field/start_menu.c" 2
...
__attribute__((section("ewram_data"))) static u8 sCurrentStartMenuActions[10] = {0};
...
static void InitStartMenu(void)
{
    ...
    while (InitStartMenuMultistep(&step, &index) == 0)
        ;
}

static void Task_StartMenu(u8 taskId)
{
    if (InitStartMenuMultistep(gTasks[taskId].data, gTasks[taskId].data + 1) == 1)
    {
...
static u8 SaveDialogCB_SaveFileExists(void)
{
    DisplaySaveMessageWithCallback(
      gDifferentSaveFile == 1 ? gSaveText_ThereIsADifferentFile : gSaveText_ThereIsAlreadyAFile,
...
static bool32 sub_80719FC(u8 *step)
{
    ...
    case 2:
        ...
        InitMenuWindow(&gWindowConfig_81E6CE4);
        (*(vu16 *)(0x4000000 + 0x0)) = 0x0000 | 0x0100;
        break;
    case 3:
    {
        u32 savedIme;
