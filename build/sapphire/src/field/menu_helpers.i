...
# 13 "src/field/menu_helpers.c" 2
# 1 "include/sprite.h" 1
# 14 "src/field/menu_helpers.c" 2
# 1 "include/task.h" 1
# 15 "src/field/menu_helpers.c" 2
# 1 "include/text.h" 1
# 16 "src/field/menu_helpers.c" 2



static void sub_80F9834(struct Sprite *sprite);

static __attribute__((section("ewram_data"))) u8 gUnknown_020388C0[4] = {0};
static __attribute__((section("ewram_data"))) struct YesNoFuncTable gUnknown_020388C4 = {0};
...
static const struct SpritePalette gUnknown_083E5968 = { Palette_3E5948, 6 };
...
bool8 sub_80F92F4(u16 itemId)
{
    ...
    if (!(gSaveBlock1.location.mapGroup == 25 && gSaveBlock1.location.mapNum == MAP_ID_TRADE_CENTER))
    {
        return 1;
    }
...
bool8 sub_80F9344(void)
{
    if (is_c1_link_related_active() == 1 || gReceivedRemoteLinkPlayers == 1)
    {
        return 1;
    }
