# 1 "src/field/field_ground_effect.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/field_ground_effect.c"
...
# 2 "src/field/field_ground_effect.c" 2
...
# 3 "src/field/field_ground_effect.c" 2
...
# 4 "src/field/field_ground_effect.c" 2
...
# 5 "src/field/field_ground_effect.c" 2
...
# 6 "src/field/field_ground_effect.c" 2
...
# 7 "src/field/field_ground_effect.c" 2
...
# 8 "src/field/field_ground_effect.c" 2
...
u8 FieldObjectCheckForReflectiveSurface(struct MapObject *mapObj)
{
    ...
    {
        b = MapGridGetMetatileBehaviorAt(mapObj->coords2.x, mapObj->coords2.y + one + i); result = GetReflectionTypeByMetatileBehavior(b); if (result != 0) return result;
        b = MapGridGetMetatileBehaviorAt(mapObj->coords3.x, mapObj->coords3.y + one + i); result = GetReflectionTypeByMetatileBehavior(b); if (result != 0) return result;
        for (j = 1; j < width; j++)
        {
            b = MapGridGetMetatileBehaviorAt(mapObj->coords2.x + j, mapObj->coords2.y + one + i); result = GetReflectionTypeByMetatileBehavior(b); if (result != 0) return result;
            b = MapGridGetMetatileBehaviorAt(mapObj->coords2.x - j, mapObj->coords2.y + one + i); result = GetReflectionTypeByMetatileBehavior(b); if (result != 0) return result;
            b = MapGridGetMetatileBehaviorAt(mapObj->coords3.x + j, mapObj->coords3.y + one + i); result = GetReflectionTypeByMetatileBehavior(b); if (result != 0) return result;
            b = MapGridGetMetatileBehaviorAt(mapObj->coords3.x - j, mapObj->coords3.y + one + i); result = GetReflectionTypeByMetatileBehavior(b); if (result != 0) return result;
        }
    }
    return 0;
...
{
    u8 i;
    for (i = 0; i < (sizeof(gUnknown_083760A0) / sizeof((gUnknown_083760A0)[0])); i++, flags >>= 1)
        if (flags & 1)
