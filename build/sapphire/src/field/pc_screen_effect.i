# 1 "src/field/pc_screen_effect.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/pc_screen_effect.c"
...
# 2 "src/field/pc_screen_effect.c" 2
# 1 "include/main.h" 1
...
# 3 "src/field/pc_screen_effect.c" 2
...
# 4 "src/field/pc_screen_effect.c" 2
# 1 "include/sprite.h" 1
# 5 "src/field/pc_screen_effect.c" 2
...
void sub_80C5CD4(struct UnkStruct *unkStruct)
{
    ...
    (*(vu16 *)(0x4000000 + 0x50)) = 191;
    (*(vu16 *)(0x4000000 + 0x54)) = 16;
}
