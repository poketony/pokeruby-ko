...
# 8 "src/field/trainer_see.c" 2
# 1 "include/sprite.h" 1
# 9 "src/field/trainer_see.c" 2
# 1 "include/task.h" 1
# 10 "src/field/trainer_see.c" 2
# 1 "include/util.h" 1
...
bool8 TrainerCanApproachPlayer(struct MapObject *trainerObj)
{
    ...
    else
    {
        for (i = 0; i < 4; i++)
        {
            ...
            if (CheckPathBetweenTrainerAndPlayer((struct MapObject2 *)trainerObj, approachDistance, i + 1))
