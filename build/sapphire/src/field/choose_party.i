...
# 10 "src/field/choose_party.c" 2
# 1 "include/pokemon.h" 1
# 11 "src/field/choose_party.c" 2
...
# 18 "src/field/choose_party.c" 2
# 1 "include/task.h" 1
# 19 "src/field/choose_party.c" 2
# 1 "include/text.h" 1
# 20 "src/field/choose_party.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 21 "src/field/choose_party.c" 2
...
{
    ClearPartySelection();
    (*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk263 = 0;
...
{
    ClearPartySelection();
    (*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk263 = 1;
    OpenPartyMenu(PARTY_MENU_TYPE_BATTLE_TOWER, 0);
}
...
bool8 SetupBattleTowerPartyMenu(void)
{
    ...
    case 6:
        for (i = 0; i < gPlayerPartyCount; i++)
        {
            ...
            if (j == 3)
            {
                if (IsMonAllowedInBattleTower(&gPlayerParty[i]) == 1)
                    sub_806BC3C(i, 0x70);
                else
                    sub_806BC3C(i, 0x7E);
            }
...
static bool8 IsMonAllowedInBattleTower(struct Pokemon *pkmn)
{
    ...
    if ((*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk263 == 0)
    {
...
static u8 sub_81220C8(void)
{
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        (*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk282 = GetMonData(&gUnknown_030042FC[gSelectedOrderFromParty[i]], 11);
        (*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk280 = GetMonData(&gUnknown_030042FC[gSelectedOrderFromParty[i]], 12);
        for (j = i + 1; j < 3; j++)
        {
            if ((*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk282 == GetMonData(&gUnknown_030042FC[gSelectedOrderFromParty[j]], 11))
                return 0x12;
            if ((*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk280 != 0 && (*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk280 == GetMonData(&gUnknown_030042FC[gSelectedOrderFromParty[j]], 12))
                return 0x13;
        }
    }
    return 0xFF;
...
{
    {(sizeof(gUnknown_084017D0) / sizeof((gUnknown_084017D0)[0])), 11, gUnknown_084017D0},
    {(sizeof(gUnknown_084017D3) / sizeof((gUnknown_084017D3)[0])), 11, gUnknown_084017D3},
    {(sizeof(gUnknown_084017D6) / sizeof((gUnknown_084017D6)[0])), 11, gUnknown_084017D6},
};
...
static void sub_81221F8(u8 taskId)
{
    ...
    if (IsMonAllowedInBattleTower(&gPlayerParty[gLastFieldPokeMenuOpened]) == 1)
    {
        if (IsPartyMemberAlreadySelected(gLastFieldPokeMenuOpened + 1) == 1)
        {
...
static void sub_8122530(void)
{
    while (1)
    {
        if (InitPartyMenu() == 1)
        {
            sub_806C994((*(struct Unk201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId, gUnknown_020384F0);
            ChangeBattleTowerPartyMenuSelection((*(struct Unk201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId, 0);
            GetMonNickname(&gPlayerParty[gUnknown_020384F0], gStringVar1);
            gLastFieldPokeMenuOpened = gUnknown_020384F0;
            sub_81221F8((*(struct Unk201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId);
...
static void sub_81225D4(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        ...
        DestroyTask(taskId);
        (*(struct Unk201B000 *)(gSharedMem + 0x1B000)).unk262 = 1;
...
{
    MenuZeroFillWindowRect(18, 10, 29, 19);
    HandleDestroyMenuCursors();
...
bool8 SetupLinkMultiBattlePartyMenu(void)
{
    ...
    {
    case 0:
        sub_81228E8((*(struct Struct201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId);
        (*(struct Struct201B000 *)(gSharedMem + 0x1B000)).setupState++;
        break;
    case 1:
        LoadHeldItemIconGraphics();
        ...
        break;
    case 2:
        sub_8122950((*(struct Struct201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId);
        (*(struct Struct201B000 *)(gSharedMem + 0x1B000)).setupState++;
        break;
    case 3:
        sub_81229B8();
...
static void sub_8122950(u8 a)
{
    ...
    for (i = 0; i < 3; i++)
    {
        if (GetMonData(&gPlayerParty[i], 11) != 0)
        {
            u16 item = GetMonData(&gPlayerParty[i], 12);
...
{
    {(sizeof(gUnknown_08401808) / sizeof((gUnknown_08401808)[0])), 11, gUnknown_08401808},
    {(sizeof(gUnknown_0840180B) / sizeof((gUnknown_0840180B)[0])), 11, gUnknown_0840180B},
};

static void sub_8122D94(u8 taskId)
{
    if (!GetMonData(&gPlayerParty[gLastFieldPokeMenuOpened], 45))
    {
        gTasks[taskId].data[4] = 0;
...
static void sub_8122F90(void)
{
    while (1)
    {
        if (InitPartyMenu() == 1)
        {
            ...
            GetMonNickname(&gPlayerParty[gUnknown_020384F0], gStringVar1);
            gLastFieldPokeMenuOpened = gUnknown_020384F0;
            sub_8122D94((*(struct Unk201B000 *)(gSharedMem + 0x1B000)).menuHandlerTaskId);
            SetMainCallback2(CB2_PartyMenuMain);
            break;
        }
        if (sub_80F9344() == 1)
