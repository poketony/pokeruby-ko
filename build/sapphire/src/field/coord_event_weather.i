# 1 "src/field/coord_event_weather.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/field/coord_event_weather.c"
...
# 2 "src/field/coord_event_weather.c" 2
# 1 "include/coord_event_weather.h" 1



void DoCoordEventWeather(u8);
# 3 "src/field/coord_event_weather.c" 2
...
# 4 "src/field/coord_event_weather.c" 2
...
{
    u8 i;
    for (i = 0; i < (sizeof(sCoordEventWeatherFuncs) / sizeof((sCoordEventWeatherFuncs)[0])); i++)
    {
