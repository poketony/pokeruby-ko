...
__attribute__((section("ewram_data"))) u8 *gUnknown_0202E8AC = ((void *)0);
...
void ClearRamScript(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gSaveBlock1.ramScript, 0x04000000 | 0x01000000 | ((sizeof(struct RamScript))/(32/8) & 0x1FFFFF)); };
}
