...
# 5 "src/engine/load_save.c" 2
# 1 "include/pokemon.h" 1
# 6 "src/engine/load_save.c" 2
...
static __attribute__((section("ewram_data"))) struct LoadedSaveData gLoadedSaveData = {0};
