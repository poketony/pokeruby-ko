...
# 14 "src/engine/main.c" 2
# 1 "include/siirtc.h" 1
# 15 "src/engine/main.c" 2
# 1 "include/sound.h" 1
...
const u8 gGameVersion = VERSION_SAPPHIRE;
...
__attribute__((section("ewram_data"))) u8 gSharedMem[0x20000] = {0};
__attribute__((section("ewram_data"))) void (**gFlashTimerIntrFunc)(void) = ((void *)0);
...
static void UpdateLinkAndCallCallbacks(void)
{
    ...
    if (!(gLinkStatus & 0x00000100) || sub_8055940() != 1)
        CallCallbacks();
}
