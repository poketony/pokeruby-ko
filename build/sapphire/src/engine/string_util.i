...
static const u8 *ExpandPlaceholder_Older(void)
{
    if (gSaveBlock2.playerGender == MALE)
        return gExpandedPlaceholder_Brother;
    else
        return gExpandedPlaceholder_Sister;
}

static const u8 *ExpandPlaceholder_Older2(void)
{
    if (gSaveBlock2.playerGender == MALE)
        return gExpandedPlaceholder_Brother2;
    else
        return gExpandedPlaceholder_Sister2;
}
# 489 "src/engine/string_util.c"
static const u8 *ExpandPlaceholder_Version(void) { return gExpandedPlaceholder_Sapphire; } static const u8 *ExpandPlaceholder_EvilTeam(void) { return gExpandedPlaceholder_Aqua; } static const u8 *ExpandPlaceholder_GoodTeam(void) { return gExpandedPlaceholder_Magma; } static const u8 *ExpandPlaceholder_EvilLeader(void) { return gExpandedPlaceholder_Archie; } static const u8 *ExpandPlaceholder_GoodLeader(void) { return gExpandedPlaceholder_Maxie; } static const u8 *ExpandPlaceholder_EvilLegendary(void) { return gExpandedPlaceholder_Kyogre; } static const u8 *ExpandPlaceholder_GoodLegendary(void) { return gExpandedPlaceholder_Groudon; }
# 498 "src/engine/string_util.c"
const u8 *GetExpandedPlaceholder(u32 id)
{
