...
# 22 "src/engine/cable_club.c" 2
# 1 "include/task.h" 1
# 23 "src/engine/cable_club.c" 2
# 1 "include/text.h" 1
# 24 "src/engine/cable_club.c" 2
...
u8 sub_8083664(void)
{
    if (FuncIsActiveTask(sub_8083710) != 0)
        return 0xFF;
...
static void sub_808382C(u8 taskId)
{
    ...
    case 5:
        ...
        {
        case 1:
            gBattleTypeFlags = 0x0008 | 0x0002;
            break;
        case 2:
            gBattleTypeFlags = 0x0008 | 0x0002 | 0x0001;
            break;
        case 5:
            ReducePlayerPartyToThree();
            gBattleTypeFlags = 0x0008 | 0x0002 | 0x0001 | 0x0040;
            break;
        }
