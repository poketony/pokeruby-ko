# 1 "src/engine/reset_rtc_screen.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/engine/reset_rtc_screen.c"
...
# 2 "src/engine/reset_rtc_screen.c" 2
...
# 3 "src/engine/reset_rtc_screen.c" 2
# 1 "include/main.h" 1
...
# 4 "src/engine/reset_rtc_screen.c" 2
# 1 "include/menu.h" 1
...
# 5 "src/engine/reset_rtc_screen.c" 2
...
# 6 "src/engine/reset_rtc_screen.c" 2
# 1 "include/rtc.h" 1
...
# 7 "src/engine/reset_rtc_screen.c" 2
# 1 "include/save.h" 1
...
# 8 "src/engine/reset_rtc_screen.c" 2
# 1 "include/sprite.h" 1
# 9 "src/engine/reset_rtc_screen.c" 2
# 1 "include/songs.h" 1
...
# 10 "src/engine/reset_rtc_screen.c" 2
# 1 "include/sound.h" 1
...
# 11 "src/engine/reset_rtc_screen.c" 2
...
# 12 "src/engine/reset_rtc_screen.c" 2
...
# 13 "src/engine/reset_rtc_screen.c" 2
...
# 14 "src/engine/reset_rtc_screen.c" 2
# 1 "include/task.h" 1
# 15 "src/engine/reset_rtc_screen.c" 2
# 1 "include/text.h" 1
# 16 "src/engine/reset_rtc_screen.c" 2
...
# 17 "src/engine/reset_rtc_screen.c" 2
...
void Task_ResetRtc_1(u8 taskId)
{
    ...
    else if (ResetRtcScreen_MoveTimeUpDown(&data[selectionInfo->dataIndex], selectionInfo->minVal, selectionInfo->maxVal, gMain.newAndRepeatedKeys & (0x0040 | 0x0080)))
    {
        PlaySE(SE_SELECT);
