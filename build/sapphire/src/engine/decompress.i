...
# 6 "src/engine/decompress.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 7 "src/engine/decompress.c" 2
...
void LoadCompressedObjectPic(const struct CompressedSpriteSheet *src)
{
    ...
    LZ77UnCompWram(src->data, (void *)0x02000000);
    dest.data = (void *)0x02000000;
    dest.size = src->size;
    dest.tag = src->tag;
