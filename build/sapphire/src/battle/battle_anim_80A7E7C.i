# 1 "src/battle/battle_anim_80A7E7C.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/battle/battle_anim_80A7E7C.c"
...
# 2 "src/battle/battle_anim_80A7E7C.c" 2
...
# 3 "src/battle/battle_anim_80A7E7C.c" 2
...
# 4 "src/battle/battle_anim_80A7E7C.c" 2
# 1 "include/sprite.h" 1
# 5 "src/battle/battle_anim_80A7E7C.c" 2
# 1 "include/task.h" 1
# 6 "src/battle/battle_anim_80A7E7C.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 7 "src/battle/battle_anim_80A7E7C.c" 2
...
void sub_80A7E7C(u8 taskId)
{
    ...
    gTasks[taskId].func = sub_80A7EF0;
    sub_80A7EF0(taskId);
}
...
void sub_80A7FA0(u8 taskId)
{
    ...
    else if (gBattleAnimArgs[0] != 8)
    {
        ...
        if (IsAnimBankSpriteVisible(side) == 0)
        {
            r6 = 1;
        }
    ...
    gTasks[taskId].data[4] = gBattleAnimArgs[1];
    gTasks[taskId].data[5] = gBattleAnimArgs[2];
    gTasks[taskId].func = sub_80A808C;
    sub_80A808C(taskId);
}
...
void sub_80A8154(u8 taskId)
{
    ...
    gTasks[taskId].func = sub_80A81D8;
    sub_80A81D8(taskId);
}
...
void sub_80A8314(u8 taskId)
{
    ...
    gTasks[taskId].data[4] = gBattleAnimArgs[4];
    gTasks[taskId].func = sub_80A8374;
    sub_80A8374(taskId);
}
...
static void sub_80A8374(u8 taskId)
{
    ...
    gSprites[sprite].pos2.y = gTasks[taskId].data[9] >> 8;
...
void sub_80A8408(u8 taskId)
{
    ...
    gTasks[taskId].data[2] = gBattleAnimArgs[2];
    gTasks[taskId].data[3] = gBattleAnimArgs[3];
    gTasks[taskId].data[4] = v1;
    gTasks[taskId].func = sub_80A8488;
    sub_80A8488(taskId);
}
...
static void sub_80A8488(u8 taskId)
{
    u8 sprite;
    sprite = gTasks[taskId].data[0];
    gSprites[sprite].pos2.x = Sin(gTasks[taskId].data[5], gTasks[taskId].data[1]);
    gSprites[sprite].pos2.y = -Cos(gTasks[taskId].data[5], gTasks[taskId].data[2]);
    gSprites[sprite].pos2.y += gTasks[taskId].data[2];
...
void sub_80A8920(u8 taskId)
{
    ...
    gTasks[taskId].func = sub_80A89B4;
}
...
static void sub_80A89B4(u8 taskId)
{
    ...
    if (--gTasks[taskId].data[3] == 0)
    {
        gTasks[taskId].func = sub_80A8A18;
    }
}
...
void sub_80A8B88(u8 taskId)
{
    ...
    {
        gTasks[taskId].data[5] = gBattleAnimBankAttacker;
    }
    else
    {
        gTasks[taskId].data[5] = gBattleAnimBankTarget;
    }
    gTasks[taskId].data[12] = 1;
    gTasks[taskId].func = sub_80A8C0C;
}
...
static void sub_80A8C0C(u8 taskId)
{
    ...
    val = gTasks[taskId].data[10] + gTasks[taskId].data[2];
    gTasks[taskId].data[10] = val;
    index = val >> 8;
    y = Sin(index, gTasks[taskId].data[1]);
    ...
    {
        if (GetBankSide(gTasks[taskId].data[5]) == 0)
        {
    ...
    if (((index >= 0x80u) && (gTasks[taskId].data[11] == 0) && (gTasks[taskId].data[12] == 1))
        || ((index < 0x7fu) && (gTasks[taskId].data[11] == 1) && (gTasks[taskId].data[12] == 0)))
    {
...
void sub_80A8D34(u8 taskId)
{
    ...
    gTasks[taskId].func = sub_80A8D8C;
}
...
void sub_80A8E04(u8 taskId)
{
    ...
    else
    {
        ...
        {
            gTasks[taskId].data[7] = !GetBankSide(gBattleAnimBankAttacker);
        }
        else
        {
            gTasks[taskId].data[7] = !GetBankSide(gBattleAnimBankTarget);
        }
    }
    ...
    gTasks[taskId].func = sub_80A8FD8;
}
...
void sub_80A8FD8(u8 taskId)
{
    ...
    if (gTasks[taskId].data[7])
    {
        sub_8078F9C(gTasks[taskId].data[5]);
    }
    if (++gTasks[taskId].data[1] >= gTasks[taskId].data[2])
    {
        ...
        {
        case 1:
            sub_8078F40(gTasks[taskId].data[5]);
        case 0:
        default:
            DestroyAnimVisualTask(taskId);
            return;
...
void sub_80A9058(u8 taskId)
{
    if (!gBattleAnimArgs[0])
    {
        gTasks[taskId].data[15] = gMovePowerMoveAnim / 12;
    ...
    {
        gTasks[taskId].data[15] = gMoveDmgMoveAnim / 12;
        if (gTasks[taskId].data[15] < 1)
        {
            gTasks[taskId].data[15] = 1;
        }
    ...
    gTasks[taskId].data[1] = gBattleAnimArgs[1];
    gTasks[taskId].data[2] = gBattleAnimArgs[2];
    gTasks[taskId].func = sub_80A913C;
}
