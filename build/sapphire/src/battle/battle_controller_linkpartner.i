# 1 "src/battle/battle_controller_linkpartner.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/battle/battle_controller_linkpartner.c"
...
# 2 "src/battle/battle_controller_linkpartner.c" 2
...
# 3 "src/battle/battle_controller_linkpartner.c" 2
...
# 4 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/data2.h" 1
...
# 5 "src/battle/battle_controller_linkpartner.c" 2
...
void sub_811EC68(u8);
# 6 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/battle_anim_813F0F4.h" 1



void sub_8141828();
# 7 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/link.h" 1
# 32 "include/link.h"
enum
{
...
void SerialCB(void);
# 8 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/m4a.h" 1
...
# 9 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/main.h" 1
...
# 10 "src/battle/battle_controller_linkpartner.c" 2
...
# 11 "src/battle/battle_controller_linkpartner.c" 2
...
# 12 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/pokemon.h" 1
# 13 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/rom3.h" 1
...
void EmitResetActionMoveSelection(u8 a, u8 b);
void Emitcmd55(u8 a, u8 b);
# 14 "src/battle/battle_controller_linkpartner.c" 2
...
# 15 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/sound.h" 1
...
# 16 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/songs.h" 1
...
# 17 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/sprite.h" 1
# 18 "src/battle/battle_controller_linkpartner.c" 2
...
# 19 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/task.h" 1
# 20 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/text.h" 1
# 77 "include/text.h"
struct WindowConfig
{
...
# 21 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/util.h" 1
...
# 22 "src/battle/battle_controller_linkpartner.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 23 "src/battle/battle_controller_linkpartner.c" 2
...
void sub_811DCA0(void)
{
    ...
    if (!((struct Struct2017810 *) (gSharedMem + 0x17810))[gActiveBank].unk0_3)
    {

        r2 = *((u8 *)&((struct Struct2017810 *) (gSharedMem + 0x17810))[gActiveBank ^ 2]) & 8;
        if (!r2 && (++((struct Struct2017810 *) (gSharedMem + 0x17810))[gActiveBank].unk9) != 1)
        {
            ((struct Struct2017810 *) (gSharedMem + 0x17810))[gActiveBank].unk9 = r2;
            ...
            (s8)((struct Struct2017810 *) (gSharedMem + 0x17810))[4].unk9 &= ~1;
...
void sub_811DE98(void)
{
    ...
    {
        nullsub_9(GetMonData(&gPlayerParty[gBattlePartyID[gActiveBank]], 11));
...
void LinkPartnerHandleLoadPokeSprite(void)
{
    ...
    GetMonSpriteTemplate_803C56C(
      GetMonData(&gPlayerParty[gBattlePartyID[gActiveBank]], 11),
...
void sub_811F864(u8 a, u8 b)
{
    ...
    species = GetMonData(&gPlayerParty[gBattlePartyID[a]], 11);
...
void LinkPartnerHandleHealthBarUpdate(void)
{
    ...
    if (r7 != 0x7FFF)
    {
        ...
        u32 hp = GetMonData(&gPlayerParty[gBattlePartyID[gActiveBank]], 57);
