# 1 "src/battle/battle_controller_opponent.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/battle/battle_controller_opponent.c"
...
# 2 "src/battle/battle_controller_opponent.c" 2
...
# 3 "src/battle/battle_controller_opponent.c" 2
...
# 4 "src/battle/battle_controller_opponent.c" 2
# 1 "include/data2.h" 1
...
# 5 "src/battle/battle_controller_opponent.c" 2
...
void sub_811EC68(u8);
# 6 "src/battle/battle_controller_opponent.c" 2
# 1 "include/battle_anim_813F0F4.h" 1



void sub_8141828();
# 7 "src/battle/battle_controller_opponent.c" 2
...
# 8 "src/battle/battle_controller_opponent.c" 2
# 1 "include/link.h" 1
# 32 "include/link.h"
enum
{
...
void SerialCB(void);
# 9 "src/battle/battle_controller_opponent.c" 2
# 1 "include/m4a.h" 1
...
# 10 "src/battle/battle_controller_opponent.c" 2
# 1 "include/main.h" 1
...
# 11 "src/battle/battle_controller_opponent.c" 2
...
# 12 "src/battle/battle_controller_opponent.c" 2
...
# 13 "src/battle/battle_controller_opponent.c" 2
# 1 "include/pokemon.h" 1
# 14 "src/battle/battle_controller_opponent.c" 2
# 1 "include/rom3.h" 1
...
void EmitResetActionMoveSelection(u8 a, u8 b);
void Emitcmd55(u8 a, u8 b);
# 15 "src/battle/battle_controller_opponent.c" 2
...
# 16 "src/battle/battle_controller_opponent.c" 2
# 1 "include/sound.h" 1
...
# 17 "src/battle/battle_controller_opponent.c" 2
# 1 "include/songs.h" 1
...
# 18 "src/battle/battle_controller_opponent.c" 2
# 1 "include/sprite.h" 1
# 19 "src/battle/battle_controller_opponent.c" 2
...
# 20 "src/battle/battle_controller_opponent.c" 2
# 1 "include/task.h" 1
# 21 "src/battle/battle_controller_opponent.c" 2
# 1 "include/text.h" 1
# 77 "include/text.h"
struct WindowConfig
{
...
# 22 "src/battle/battle_controller_opponent.c" 2
# 1 "include/util.h" 1
...
# 23 "src/battle/battle_controller_opponent.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 24 "src/battle/battle_controller_opponent.c" 2
...
void OpponentHandlecmd1(void)
{
    ...
    { dst = (u8 *)&buffer + gBattleBufferA[gActiveBank][1]; for(i = 0; i < (u32)gBattleBufferA[gActiveBank][2]; i++) dst[i] = src[i]; };
...
# 1496 "src/battle/battle_controller_opponent.c"
__attribute__((naked))
void OpponentHandlecmd20(void)
{
...
# 1671 "src/battle/battle_controller_opponent.c"
}
...
void OpponentHandleOpenBag(void)
{
    ...
    Emitcmd35(1, (gSharedMem[0x160D4 + (gActiveBank / 2) * 2]));
    OpponentBufferExecCompleted();
}
...
void OpponentHandlecmd22(void)
{
    ...
    if ((gSharedMem[0x160C8 + (GetBankIdentity(gActiveBank) / 2)]) == 6)
    {
        u8 r6;
        u8 r5;
        ...
        if (r4 == 6)
        {
            ...
            for (r4 = 0; r4 < 6; r4++)
            {
                if (GetMonData(&gEnemyParty[r4], 57) != 0
    ...
    {
        r4 = (gSharedMem[0x160C8 + (GetBankIdentity(gActiveBank) / 2)]);
        (gSharedMem[0x160C8 + (GetBankIdentity(gActiveBank) / 2)]) = 6;
    }
    (gSharedMem[0x16068 + gActiveBank]) = r4;
    Emitcmd34(1, r4, 0);
    OpponentBufferExecCompleted();
}
