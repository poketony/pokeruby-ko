...
# 5 "src/battle/battle_7.c" 2
# 1 "include/blend_palette.h" 1



void BlendPalette(u16 palOffset, u16 numEntries, u8 coeff, u16 blendColor);
# 6 "src/battle/battle_7.c" 2
# 1 "include/data2.h" 1
...
# 11 "src/battle/battle_7.c" 2
# 1 "include/pokemon.h" 1
# 12 "src/battle/battle_7.c" 2
...
# 17 "src/battle/battle_7.c" 2
# 1 "include/sprite.h" 1
# 18 "src/battle/battle_7.c" 2
# 1 "include/task.h" 1
# 19 "src/battle/battle_7.c" 2
# 1 "include/text.h" 1
# 77 "include/text.h"
struct WindowConfig
{
...
# 20 "src/battle/battle_7.c" 2
# 1 "include/gba/m4a_internal.h" 1
# 21 "src/battle/battle_7.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 22 "src/battle/battle_7.c" 2
...
{
    ((struct Struct2017810 *) (gSharedMem + 0x17810))[gActiveBank].unk0_4 = 1;
    if (a == 0)
    {
        if (b == 0x20)
...
bool8 move_anim_start_t3(u8 a, u8 b, u8 c, u8 d, u16 e)
{
    ...
    if (((struct Struct2017800 *) (gSharedMem + 0x17800))[a].substituteSprite && sub_803163C(d) == 0)
        return 1;
    if (((struct Struct2017800 *) (gSharedMem + 0x17800))[a].substituteSprite && d == 2 && gSprites[gObjectBankIDs[a]].invisible)
    {
    ...
    (*(struct Struct2017840 *) (gSharedMem + 0x17840)).unk0 = e;
    DoMoveAnim(gBattleAnims_General, d, 0);
    taskId = CreateTask(sub_80315E8, 10);
    gTasks[taskId].data[0] = a;
    ((struct Struct2017810 *) (gSharedMem + 0x17810))[gTasks[taskId].data[0]].unk0_5 = 1;
    return 0;
}
...
void sub_80315E8(u8 taskId)
{
    ...
    {
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[gTasks[taskId].data[0]].unk0_5 = 0;
        DestroyTask(taskId);
    }
}
...
void move_anim_start_t4(u8 a, u8 b, u8 c, u8 d)
{
    ...
    gTasks[taskId].data[0] = a;
    ((struct Struct2017810 *) (gSharedMem + 0x17810))[gTasks[taskId].data[0]].unk0_6 = 1;
}
...
void sub_80316CC(u8 taskId)
{
    ...
    if (!gAnimScriptActive)
    {
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[gTasks[taskId].data[0]].unk0_6 = 0;
        DestroyTask(taskId);
    }
}
...
bool8 mplay_80342A4(u8 a)
{
    ...
    if (IsSEPlaying())
    {
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk8++;
        if (((struct Struct2017810 *) (gSharedMem + 0x17810))[gActiveBank].unk8 < 30)
            return 1;
    ...
    if (zero == 0)
    {
        ((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk8 = 0;
        return 0;
    }
    return 1;
}
...
void BattleLoadOpponentMonSprite(struct Pokemon *pkmn, u8 b)
{
    ...
    personalityValue = GetMonData(pkmn, 0);
    if (((struct Struct2017800 *) (gSharedMem + 0x17800))[b].transformedSpecies == 0)
    {
    ...
    {
        species = ((struct Struct2017800 *) (gSharedMem + 0x17800))[b].transformedSpecies;
        r7 = gPID_perBank[b];
    }
    otId = GetMonData(pkmn, 1);
    ...
    {
        paletteOffset = 0x100 + b * 16;
        LZDecompressWram(lzPaletteData, (gSharedMem + 0x16400));
        LoadPalette((gSharedMem + 0x16400) + gBattleMonForms[b] * 32, paletteOffset, 0x20);
    }
    if (((struct Struct2017800 *) (gSharedMem + 0x17800))[b].transformedSpecies != 0)
    {
...
{
    LZDecompressWram(gUnknown_08D09C48, (void *)(0x02000000 + 0x0));
}
...
{
    memset(((struct Struct2017810 *) (gSharedMem + 0x17810)), 0, 0x30);
    memset(&(*(struct Struct2017840 *) (gSharedMem + 0x17840)), 0, 0x10);
}

void sub_8031F0C(void)
{
    sub_8031EE8();
    memset(((struct Struct2017800 *) (gSharedMem + 0x17800)), 0, 0x10);
}
...
void sub_8031F24(void)
{
    ...
    for (i = 0; i < gNoOfAllBanks; i++)
        ((struct Struct2017800 *) (gSharedMem + 0x17800))[i].invisible = gSprites[gObjectBankIDs[i]].invisible;
}

void sub_8031F88(u8 a)
{
    ((struct Struct2017800 *) (gSharedMem + 0x17800))[a].invisible = gSprites[gObjectBankIDs[a]].invisible;
}
...
void sub_8031FC4(u8 a, u8 b, bool8 c)
{
    ...
    if (c)
    {
        StartSpriteAnim(&gSprites[gObjectBankIDs[a]], (*(struct Struct2017840 *) (gSharedMem + 0x17840)).unk0);
        paletteOffset = 0x100 + a * 16;
        LoadPalette((gSharedMem + 0x16400) + (*(struct Struct2017840 *) (gSharedMem + 0x17840)).unk0 * 32, paletteOffset, 32);
        gBattleMonForms[a] = (*(struct Struct2017840 *) (gSharedMem + 0x17840)).unk0;
        if (((struct Struct2017800 *) (gSharedMem + 0x17800))[a].transformedSpecies != 0)
        {
            BlendPalette(paletteOffset, 16, 6, 0x7FFF);
            CpuSet(gPlttBufferFaded + paletteOffset, gPlttBufferUnfaded + paletteOffset, 0x04000000 | ((32)/(32/8) & 0x1FFFFF));
        }
    ...
    else
    {
        ...
        if (NotInBattle())
        {
            ...
            personalityValue = (*(struct Struct2019348 *)(gSharedMem + 0x19348)).unk8;
            otId = (*(struct Struct2019348 *)(gSharedMem + 0x19348)).unkC;
            HandleLoadSpecialPokePic(
              &gMonBackPicTable[species],
              gMonBackPicCoords[species].coords,
              gMonBackPicCoords[species].y_offset,
              ...
              gUnknown_081FAF4C[0],
              species,
              (*(struct Struct2019348 *)(gSharedMem + 0x19348)).unk10);
        }
        else
        {
            r10 = GetBankIdentity(a);
            if (GetBankSide(b) == 1)
                species = GetMonData(&gEnemyParty[gBattlePartyID[b]], 11);
            else
                species = GetMonData(&gPlayerParty[gBattlePartyID[b]], 11);
            if (GetBankSide(a) == 0)
            {
                personalityValue = GetMonData(&gPlayerParty[gBattlePartyID[a]], 0);
                otId = GetMonData(&gPlayerParty[gBattlePartyID[a]], 1);
                HandleLoadSpecialPokePic(
                  &gMonBackPicTable[species],
                  gMonBackPicCoords[species].coords,
                  gMonBackPicCoords[species].y_offset,
            ...
            {
                personalityValue = GetMonData(&gEnemyParty[gBattlePartyID[a]], 0);
                otId = GetMonData(&gEnemyParty[gBattlePartyID[a]], 1);
                HandleLoadSpecialPokePic(
                  &gMonFrontPicTable[species],
                  gMonFrontPicCoords[species].coords,
                  gMonFrontPicCoords[species].y_offset,
        ...
        dst = (void *)(0x6000000 + 0x10000 + gSprites[gObjectBankIDs[a]].oam.tileNum * 32);
        ...
        if (species == SPECIES_CASTFORM)
        {
            u16 *paletteSrc = (u16 *)(gSharedMem + 0x16400);
        ...
        if (!NotInBattle())
        {
            ((struct Struct2017800 *) (gSharedMem + 0x17800))[a].transformedSpecies = species;
...
void BattleLoadSubstituteSprite(u8 a, u8 b)
{
    ...
    if (b == 0)
    {
        ...
        for (i = 0; i < 3; i++)
            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(src); dmaRegs[1] = (vu32)(src + i * 0x800 + 0x800); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((0x800)/(32/8))); dmaRegs[2]; };
...
{
    if (b == 0xA4)
        ((struct Struct2017800 *) (gSharedMem + 0x17800))[a].substituteSprite = 1;
}

void sub_80324E0(u8 a)
{
    ((struct Struct2017800 *) (gSharedMem + 0x17800))[a].substituteSprite = 0;
}

void sub_80324F8(struct Pokemon *pkmn, u8 b)
{
    u16 hp = GetMonData(pkmn, 57);
    u16 maxHP = GetMonData(pkmn, 58);

    if (GetHPBarLevel(hp, maxHP) == 1)
    {
        if (!((struct Struct2017800 *) (gSharedMem + 0x17800))[b].unk0_1)
        {
            if (!((struct Struct2017800 *) (gSharedMem + 0x17800))[b ^ 2].unk0_1)
                PlaySE(SE_HINSI);
            ((struct Struct2017800 *) (gSharedMem + 0x17800))[b].unk0_1 = 1;
        }
    }
    else
    {
        ((struct Struct2017800 *) (gSharedMem + 0x17800))[b].unk0_1 = 0;
        if (!IsDoubleBattle())
        {
            m4aSongNumStop(SE_HINSI);
            return;
        }
        if (IsDoubleBattle() && !((struct Struct2017800 *) (gSharedMem + 0x17800))[b ^ 2].unk0_1)
        {
            m4aSongNumStop(SE_HINSI);
            return;
        }
...
void BattleMusicStop(void)
{
    ...
    ((struct Struct2017800 *) (gSharedMem + 0x17800))[r4].unk0_1 = 0;
    if (IsDoubleBattle())
        ((struct Struct2017800 *) (gSharedMem + 0x17800))[r4 ^ 2].unk0_1 = 0;
    m4aSongNumStop(SE_HINSI);
}
...
void sub_8032638(void)
{
    if (gMain.inBattle)
    {
        ...
        if (GetMonData(&gPlayerParty[r4], 57) != 0)
            sub_80324F8(&gPlayerParty[r4], r8);
        if (IsDoubleBattle())
        {
            if (GetMonData(&gPlayerParty[r5], 57) != 0)
...
void sub_80326EC(u8 a)
{
    ...
    for (i = 0; i < gNoOfAllBanks; i++)
    {
        if (AnimBankSpriteExists(i) != 0)
        {
            ...
            if (a == 0)
            {
                ((struct Struct2017810 *) (gSharedMem + 0x17810))[i].unk6 = gSprites[gObjectBankIDs[i]].oam.matrixNum;
                gSprites[gObjectBankIDs[i]].oam.matrixNum = 0;
            }
            else
            {
                gSprites[gObjectBankIDs[i]].oam.matrixNum = ((struct Struct2017810 *) (gSharedMem + 0x17810))[i].unk6;
            }
        }
    }
}
...
void sub_80327CC(void)
{
    ...
    ((struct Struct2017810 *) (gSharedMem + 0x17810))[r5].unk7 = CreateSprite(&gSpriteTemplate_81FAF34, sub_8077ABC(r5, 0), sub_8077ABC(r5, 1) + 32, 0xC8);
    gSprites[((struct Struct2017810 *) (gSharedMem + 0x17810))[r5].unk7].data[0] = r5;
    if (IsDoubleBattle())
    {
...
void sub_80328A4(struct Sprite *sprite)
{
    ...
    if (gAnimScriptActive || r7->invisible)
        invisible = 1;
    else if (((struct Struct2017800 *) (gSharedMem + 0x17800))[r4].transformedSpecies != 0 && gEnemyMonElevation[((struct Struct2017800 *) (gSharedMem + 0x17800))[r4].transformedSpecies] == 0)
        invisible = 1;
    if (((struct Struct2017800 *) (gSharedMem + 0x17800))[r4].substituteSprite)
        invisible = 1;
...
void sub_8032984(u8 a, u16 b)
{
    ...
    {
        if (((struct Struct2017800 *) (gSharedMem + 0x17800))[a].transformedSpecies != 0)
            b = ((struct Struct2017800 *) (gSharedMem + 0x17800))[a].transformedSpecies;
        if (gEnemyMonElevation[b] != 0)
            gSprites[((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk7].callback = sub_80328A4;
        else
            gSprites[((struct Struct2017810 *) (gSharedMem + 0x17810))[a].unk7].callback = sub_8032978;
    }
}
...
{
    ((struct Struct2017800 *) (gSharedMem + 0x17800))[a].transformedSpecies = 0;
    gBattleMonForms[a] = 0;
    if (b == 0)
        sub_80324E0(a);
}
