# 1 "src/debug/matsuda_debug_menu.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/debug/matsuda_debug_menu.c"
...
# 2 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/matsuda_debug_menu.h" 1
...
# 3 "src/debug/matsuda_debug_menu.c" 2
...
# 4 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/contest_link_80C2020.h" 1
...
void sub_80C4980(u8);
u8 sub_80C4B34(u8 *);
# 5 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/contest_link_80C857C.h" 1
...
void sub_80C8EBC(u8);
void sub_80C8F34(u8);
# 6 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/data2.h" 1
...
# 7 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/link.h" 1
# 32 "include/link.h"
enum
{
...
void SerialCB(void);
# 8 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/main.h" 1
...
# 9 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/menu.h" 1
...
# 10 "src/debug/matsuda_debug_menu.c" 2
...
# 11 "src/debug/matsuda_debug_menu.c" 2
...
# 12 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/sprite.h" 1
# 13 "src/debug/matsuda_debug_menu.c" 2
...
# 14 "src/debug/matsuda_debug_menu.c" 2
...
# 15 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/task.h" 1
# 16 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/text.h" 1
# 17 "src/debug/matsuda_debug_menu.c" 2
...
# 18 "src/debug/matsuda_debug_menu.c" 2
# 1 "include/ewram.h" 1



extern u8 gSharedMem[];
# 19 "src/debug/matsuda_debug_menu.c" 2
...
const u8 gText_Unused83C9150[] = _("テストです");
const u8 gMatsudaDebugMenu_ActionContestText[] = _("콘테스트");
const u8 gMatsudaDebugMenu_ActionContestResultsText[] = _("콘테스트 결과");

const u8 gMatsudaDebugMenu_ActionChangePerimeterText[] = _("パラメータへんこう");

const u8 gMatsudaDebugMenu_ActionChangeMoveText[] = _("わざ へんこう");
const u8 gMatsudaDebugMenu_ActionContestCommText[] = _("콘테스트 통신");
const u8 gMatsudaDebugMenu_ActionCommTestText[] = _("통신 초기화");
const u8 gMatsudaDebugMenu_ActionSetHighScoreText[] = _("최고점수 데이터 설정");
const u8 gMatsudaDebugMenu_ActionResetHighScoreText[] = _("최고점수 데이터 재설정");
const u8 gMatsudaDebugMenu_ActionSetAllArtMuseumText[] = _("미술관 전체 설정");
...
static const u8 gMatsudaDebugMenu_StartJapText[] = _("かいし");
static const u8 gMatsudaDebugMenu_GoBackText[] = _("もどる");

static const u8 gMatsudaDebugMenu_BattlePointsText[] = _("{COLOR MAGENTA}BP.");

static const u8 MatsudaDebugMenuText_Cool[] = _("かっこよさ");
static const u8 MatsudaDebugMenuText_Cute[] = _("かわいさ");
static const u8 MatsudaDebugMenuText_Beauty[] = _("うつくしさ");
static const u8 MatsudaDebugMenuText_Smart[] = _("かしこさ");
static const u8 MatsudaDebugMenuText_Tough[] = _("たくましさ");
static const u8 MatsudaDebugMenuText_Sheen[] = _("けづや");
...
static const u8 MatsudaDebugMenuText_Fallarbor[] = _("ハジツゲ/ノーマル");
static const u8 MatsudaDebugMenuText_Verdanturf[] = _("シダケ/スーパー　");
static const u8 MatsudaDebugMenuText_Slateport[] = _("カイナ/ハイパー　");
static const u8 MatsudaDebugMenuText_Lilycove[] = _("ミナモ/マスター　");
...
{
    (*(vu16 *)(0x4000000 + 0x0)) = 0x0000 | 0x0040;
    (*(vu16 *)(0x4000000 + 0x0)) |= 0x1000 | 0x0100;
...
static void sub_80A9FE4(void)
{
    ...
    while (1)
    {
        ...
        if (i <= 0x1000)
        {
            { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(addr); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((i)/(32/8))); dmaRegs[2]; }; };
            break;
        }
    }
    sub_80034D4((void *)0x6000000, ptr);
...
{
    SetMonData(&gPlayerParty[0], 22, &gContestMons[gContestPlayerMonIndex].cool);
    SetMonData(&gPlayerParty[0], 24, &gContestMons[gContestPlayerMonIndex].cute);
    SetMonData(&gPlayerParty[0], 23, &gContestMons[gContestPlayerMonIndex].beauty);
    SetMonData(&gPlayerParty[0], 33, &gContestMons[gContestPlayerMonIndex].smart);
    SetMonData(&gPlayerParty[0], 47, &gContestMons[gContestPlayerMonIndex].tough);
    SetMonData(&gPlayerParty[0], 48, &gContestMons[gContestPlayerMonIndex].sheen);
    SetMonData(&gPlayerParty[0], 13, &gContestMons[gContestPlayerMonIndex].moves[0]);
    SetMonData(&gPlayerParty[0], 14, &gContestMons[gContestPlayerMonIndex].moves[1]);
    SetMonData(&gPlayerParty[0], 15, &gContestMons[gContestPlayerMonIndex].moves[2]);
    SetMonData(&gPlayerParty[0], 16, &gContestMons[gContestPlayerMonIndex].moves[3]);
}
...
static u8 sub_80AA908(u32 a1, u8 a2, s8 a3)
{
    s16 val = a2 + a3;
...
static u16 sub_80AAAC8(u32 a1, u16 a2, s8 a3)
{
    s16 val = a2 + a3;
...
# 956 "src/debug/matsuda_debug_menu.c"
__attribute__((naked))
...
# 1132 "src/debug/matsuda_debug_menu.c"
}
