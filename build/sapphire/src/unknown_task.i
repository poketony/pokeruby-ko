...
void dp12_8087EA4(void)
{
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, gUnknown_03004DE0, 0x00000000 | 0x01000000 | ((0x780 * 2)/(16/8) & 0x1FFFFF)); };
...
void sub_80895F8(struct UnknownTaskStruct unk)
{
    if (unk.control == (((0x8000 | 0x2000 | 0x0200 | 0x0060) << 16) | 1))
    {
...
void sub_8089668(void)
{
    if (gUnknown_03004DC0.unk15)
    {
        ...
        {
            { vu16 *dmaRegs = (vu16 *)(0x4000000 + 0xb0); dmaRegs[5] &= ~(0x3000 | 0x0800 | 0x0200); dmaRegs[5] &= ~0x8000; dmaRegs[5]; };
            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xb0); dmaRegs[0] = (vu32)(gUnknown_03004DC0.src[gUnknown_03004DC0.srcBank]); dmaRegs[1] = (vu32)(gUnknown_03004DC0.dest); dmaRegs[2] = (vu32)(gUnknown_03004DC0.unkC); dmaRegs[2]; };
...
u8 sub_8089944(u8 a1, u8 a2, u8 a3, u8 a4, u8 a5, u8 a6, u8 a7)
{
    ...
    unk.dest = (void *)((0x4000000 + 0x10) + a6);
    unk.control = ((0x8000 | 0x2000 | 0x0200 | 0x0060) << 16) | 1;
    unk.unk8 = 1;
    unk.unk9 = 0;
